...
public class KeyEventArgsTests {
	...
	[InlineData (Key.A, 65)] // 65 equivalent to (Key)'A', but A-Z are mapped to lower case by drivers
	[InlineData (Key.ShiftMask | Key.A, 65)]
	[InlineData (Key.CtrlMask | Key.A, 97)]
	[InlineData (Key.AltMask | Key.A, 97)]
	[InlineData (Key.ShiftMask | Key.CtrlMask | Key.A, 97)]
	[InlineData (Key.ShiftMask | Key.AltMask | Key.A, 97)]
	[InlineData (Key.AltMask | Key.CtrlMask | Key.A, 65)]
	[InlineData (Key.ShiftMask | Key.CtrlMask | Key.AltMask | Key.A, 97)]
	...
	public void KeyValueProperty_ShouldReturnCorrectIntValue (Key key, Rune expected)
	{
		var eventArgs = new KeyEventArgs (key);
	...
	public void IsAltProperty_ShouldReturnCorrectValue (Key key, bool expected)
	{
		var eventArgs = new KeyEventArgs (key);
