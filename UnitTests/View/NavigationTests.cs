...
└──────────────────┘", output);
			...
			Assert.Equal (3, ry);
			// view
			Assert.Equal (new Point (-3, -2), view.ScreenToView (0, 0));
			...
			Assert.Equal (0, rx);
			Assert.Equal (0, ry);
			Assert.Equal (Point.Empty, view.ScreenToView (3, 2));
			...
			Assert.Equal (0, rx);
			Assert.Equal (0, ry);
			Assert.Equal (new Point (10, 0), view.ScreenToView (13, 2));
			...
			Assert.Equal (14, rx);
			Assert.Equal (3, ry);
			Assert.Equal (new Point (11, 1), view.ScreenToView (14, 3));
   ...
   └──────────────────┘", output);
			...
			Assert.Equal (1, ry);
			// view
			Assert.Equal (new Point (-6, -4), view.ScreenToView (0, 0));
			...
			Assert.Equal (0, rx);
			Assert.Equal (0, ry);
			Assert.Equal (new Point (-3, -2), view.ScreenToView (3, 2));
			view.ViewToScreen (-3, -2, out col, out row);
			Assert.Equal (4, col);
			Assert.Equal (3, row);
			...
			Assert.Equal (1, rx);
			Assert.Equal (1, ry);
			Assert.Equal (Point.Empty, view.ScreenToView (6, 4));
			view.ViewToScreen (0, 0, out col, out row);
			Assert.Equal (7, col);
			Assert.Equal (5, row);
			...
			Assert.Equal (0, rx);
			Assert.Equal (0, ry);
			Assert.Equal (new Point (7, 0), view.ScreenToView (13, 4));
			...
			Assert.Equal (7, rx);
			Assert.Equal (0, ry);
			Assert.Equal (new Point (8, -1), view.ScreenToView (14, 3));
			...
			Assert.Equal (12, rx);
			Assert.Equal (2, ry);
			Assert.Equal (new Point (17, -1), view.ScreenToView (23, 3));
