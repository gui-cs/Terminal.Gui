...
public class PosTests
{
    ...
    public void AnchorEnd_View_And_Button ()
    {
        ...
        Assert.Equal (16, frame.ContentArea.Width);

        Button btn = null;

        int Btn_Width () { return btn?.ContentArea.Width ?? 0; }
        ...
        Assert.Equal (6, btn.ContentArea.Width);
        ...
        Assert.Equal (9, view.ContentArea.Width); // frame.Bounds.Width (16) - Dim.Fill (1) - Dim.Function (6) = 9
