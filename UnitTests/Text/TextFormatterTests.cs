...
000000000000000000000",
    ...
    [InlineData (
                    ...
                    false,
                    new[] {
                              " A", "sent", "ence", "has", "word", "s. ", " Thi", "s is", "the", "seco", "nd", "Line",
                              "- 2."
                          },
    ...
    public void MultiLine_WordWrap_False_Horizontal_Direction (
        ...
        List<string> splitLines = tf.Lines;
    ...
    public void ReplaceHotKeyWithTag (string text, int hotPos, uint tag, string expected) {
        ...
        string result = tf.ReplaceHotKeyWithTag (text, hotPos);
