	...
	public class ProgressBarTests {
		...
		public void Pulse_Redraw_BidirectionalMarquee_True_Default ()
		{
			...
			for (int i = 0; i < 38; i++) {
				...
				pb.Draw ();
				if (i == 0) {
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 0].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 1].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 2].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 3].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 4].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 5].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 6].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 7].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 8].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 9].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 10].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 11].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 12].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 13].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 14].Runes[0]);
				} else if (i == 1) {
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 0].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 1].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 2].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 3].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 4].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 5].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 0].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 1].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 2].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 3].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 4].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 5].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 6].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 1].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 2].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 3].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 4].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 5].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 6].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 7].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 2].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 3].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 4].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 5].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 6].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 7].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 8].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 3].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 4].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 5].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 6].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 7].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 8].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 9].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 4].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 5].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 6].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 7].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 8].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 9].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 10].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 5].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 6].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 7].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 8].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 9].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 10].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 11].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 6].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 7].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 8].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 9].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 10].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 11].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 12].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 7].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 8].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 9].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 10].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 11].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 12].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 13].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 8].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 9].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 10].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 11].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 12].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 13].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 14].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 9].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 10].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 11].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 12].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 13].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 14].Runes[0]);
				} else if (i == 12) {
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 10].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 11].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 12].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 13].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 14].Runes[0]);
				} else if (i == 13) {
					Assert.Equal ((Rune)' ', driver.Contents [0, 0].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 11].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 12].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 13].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 14].Runes[0]);
				} else if (i == 14) {
					Assert.Equal ((Rune)' ', driver.Contents [0, 0].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 1].Runes[0]);
					...
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 12].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 13].Runes[0]);
					Assert.Equal (CM.Glyphs.BlocksMeterSegment, driver.Contents [0, 14].Runes[0]);
				} else if (i == 15) {
					Assert.Equal ((Rune)' ', driver.Contents [0, 0].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 1].Runes[0]);
					Assert.Equal ((Rune)' ', driver.Contents [0, 2].Runes[0]);
