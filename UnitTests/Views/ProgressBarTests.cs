	...
	public class ProgressBarTests {
		...
		public void Pulse_Redraw_BidirectionalMarquee_True_Default ()
		{
			...
			for (int i = 0; i < 38; i++) {
				...
				pb.Draw ();
				if (i == 0) {
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 0, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 0, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 1, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 2, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 3, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 4, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 5, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 0, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 1, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 2, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 3, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 4, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 5, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 6, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 1, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 2, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 3, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 4, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 5, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 6, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 7, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 2, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 3, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 4, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 5, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 6, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 7, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 8, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 3, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 4, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 5, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 6, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 7, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 8, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 9, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 4, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 5, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 6, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 7, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 8, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 9, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 10, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 5, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 6, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 7, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 8, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 9, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 10, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 11, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 6, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 7, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 8, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 9, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 10, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 11, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 12, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 7, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 8, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 9, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 10, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 11, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 12, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 13, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 8, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 9, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 10, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 11, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 12, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 13, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 14, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 9, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 10, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 11, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 12, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 13, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 14, 0]);
				} else if (i == 12) {
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 10, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 11, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 12, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 13, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 14, 0]);
				} else if (i == 13) {
					Assert.Equal (' ', (double)driver.Contents [0, 0, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 11, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 12, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 13, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 14, 0]);
				} else if (i == 14) {
					Assert.Equal (' ', (double)driver.Contents [0, 0, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 1, 0]);
					...
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 12, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 13, 0]);
					Assert.Equal (Glyphs.BlocksMeterSegment, (double)driver.Contents [0, 14, 0]);
				} else if (i == 15) {
					Assert.Equal (' ', (double)driver.Contents [0, 0, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 1, 0]);
					Assert.Equal (' ', (double)driver.Contents [0, 2, 0]);
