...
namespace Terminal.Gui.ViewsTests {
	...
	public class TextValidateField_NET_Provider_Tests {
		...
		public void Initialized_With_Cursor_On_First_Editable_Character ()
		{
			...
			field.OnKeyPressed (new KeyEventArgs (Key.D1, new KeyModifiers { }));
		...
		public void Input_Ilegal_Character ()
		{
			...
			field.OnKeyPressed (new KeyEventArgs (Key.A, new KeyModifiers { }));
		...
		public void Home_Key_First_Editable_Character ()
		{
			...
			field.OnKeyPressed (new KeyEventArgs (Key.CursorRight, new KeyModifiers { }));
			field.OnKeyPressed (new KeyEventArgs (Key.CursorRight, new KeyModifiers { }));
			field.OnKeyPressed (new KeyEventArgs (Key.Home, new KeyModifiers { }));
		...
		public void End_Key_Last_Editable_Character ()
		{
			...
			field.OnKeyPressed (new KeyEventArgs (Key.End, new KeyModifiers { }));
		...
		public void Left_Key_Stops_In_First_Editable_Character ()
		{
			...
			for (int i = 0; i < 10; i++) {
				field.OnKeyPressed (new KeyEventArgs (Key.CursorLeft, new KeyModifiers { }));
			}
			field.OnKeyPressed (new KeyEventArgs (Key.D1, new KeyModifiers { }));
		...
		public void When_Valid_Is_Valid_True ()
		{
			...
			field.OnKeyPressed (new KeyEventArgs (Key.D2, new KeyModifiers { }));
			Assert.Equal ("--(12  )--", field.Text);
			Assert.False (field.IsValid);

			field.OnKeyPressed (new KeyEventArgs (Key.D3, new KeyModifiers { }));
			Assert.Equal ("--(123 )--", field.Text);
			Assert.False (field.IsValid);

			field.OnKeyPressed (new KeyEventArgs (Key.D4, new KeyModifiers { }));
		...
		public void Delete_Key_Dosent_Move_Cursor ()
		{
			...
			field.OnKeyPressed (new KeyEventArgs (Key.Delete, new KeyModifiers { }));
			field.OnKeyPressed (new KeyEventArgs (Key.Delete, new KeyModifiers { }));
			field.OnKeyPressed (new KeyEventArgs (Key.Delete, new KeyModifiers { }));
		...
		public void Backspace_Key_Deletes_Previous_Character ()
		{
			...
			field.OnKeyPressed (new KeyEventArgs (Key.Backspace, new KeyModifiers { }));
	...
	public class TextValidateField_Regex_Provider_Tests {
		...
		public void Home_Key_First_Editable_Character ()
		{
			...
			field.OnKeyPressed (new KeyEventArgs (Key.D1, new KeyModifiers { }));
			field.OnKeyPressed (new KeyEventArgs (Key.D0, new KeyModifiers { }));
			field.OnKeyPressed (new KeyEventArgs (Key.D0, new KeyModifiers { }));
			field.OnKeyPressed (new KeyEventArgs (Key.D0, new KeyModifiers { }));
		...
		public void End_Key_End_Of_Input ()
		{
			...
			// Insert 9
			field.OnKeyPressed (new KeyEventArgs (Key.D9, new KeyModifiers { }));
