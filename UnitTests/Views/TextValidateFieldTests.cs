...
namespace Terminal.Gui.ViewsTests {
	...
	public class TextValidateField_NET_Provider_Tests {
		...
		public void Initialized_With_Cursor_On_First_Editable_Character ()
		{
			...
			field.OnKeyPressed (new (Key.D1, new KeyModifiers { }));
		...
		public void Input_Ilegal_Character ()
		{
			...
			field.OnKeyPressed (new (Key.A, new KeyModifiers { }));
		...
		public void Home_Key_First_Editable_Character ()
		{
			...
			field.OnKeyPressed (new (Key.CursorRight, new KeyModifiers { }));
			field.OnKeyPressed (new (Key.CursorRight, new KeyModifiers { }));
			field.OnKeyPressed (new (Key.Home, new KeyModifiers { }));
		...
		public void End_Key_Last_Editable_Character ()
		{
			...
			field.OnKeyPressed (new (Key.End, new KeyModifiers { }));
		...
		public void Left_Key_Stops_In_First_Editable_Character ()
		{
			...
			for (int i = 0; i < 10; i++) {
				field.OnKeyPressed (new (Key.CursorLeft, new KeyModifiers { }));
			}
			field.OnKeyPressed (new (Key.D1, new KeyModifiers { }));
		...
		public void When_Valid_Is_Valid_True ()
		{
			...
			field.OnKeyPressed (new (Key.D2, new KeyModifiers { }));
			Assert.Equal ("--(12  )--", field.Text);
			Assert.False (field.IsValid);

			field.OnKeyPressed (new (Key.D3, new KeyModifiers { }));
			Assert.Equal ("--(123 )--", field.Text);
			Assert.False (field.IsValid);

			field.OnKeyPressed (new (Key.D4, new KeyModifiers { }));
		...
		public void Delete_Key_Dosent_Move_Cursor ()
		{
			...
			field.OnKeyPressed (new (Key.Delete, new KeyModifiers { }));
			field.OnKeyPressed (new (Key.Delete, new KeyModifiers { }));
			field.OnKeyPressed (new (Key.Delete, new KeyModifiers { }));
		...
		public void Backspace_Key_Deletes_Previous_Character ()
		{
			...
			field.OnKeyPressed (new (Key.Backspace, new KeyModifiers { }));
	...
	public class TextValidateField_Regex_Provider_Tests {
		...
		public void Home_Key_First_Editable_Character ()
		{
			...
			field.OnKeyPressed (new (Key.D1, new KeyModifiers { }));
			field.OnKeyPressed (new (Key.D0, new KeyModifiers { }));
			field.OnKeyPressed (new (Key.D0, new KeyModifiers { }));
			field.OnKeyPressed (new (Key.D0, new KeyModifiers { }));
		...
		public void End_Key_End_Of_Input ()
		{
			...
			// Insert 9
			field.OnKeyPressed (new (Key.D9, new KeyModifiers { }));
