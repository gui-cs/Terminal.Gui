...
namespace Terminal.Gui.TextTests {
	public class AppendAutocompleteTests {
		...
		public void TestAutoAppend_ShowThenAccept_MatchCase ()
		{
			...
			tf.OnKeyPressed (new (Key.f, new KeyModifiers ()));
		...
		public void TestAutoAppend_ShowThenAccept_CasesDiffer ()
		{
			...
			tf.PositionCursor ();
			TestHelpers.AssertDriverContentsAre ("", output);
			tf.OnKeyPressed (new (Key.m, new KeyModifiers ()));
			tf.OnKeyPressed (new (Key.y, new KeyModifiers ()));
			tf.OnKeyPressed (new (Key.Space, new KeyModifiers ()));
			tf.OnKeyPressed (new (Key.f, new KeyModifiers ()));
