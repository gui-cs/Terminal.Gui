...
namespace Terminal.Gui.ViewsTests {
	...
	public class TableViewTests {
		...
		public void PageDown_ExcludesHeaders ()
		{
			...
			tableView.OnKeyPressed (new KeyEventArgs (Key.PageDown, new KeyModifiers ()));
...
";
		...
		public void TableView_Activate ()
		{
			...
			tv.OnKeyPressed (new KeyEventArgs (Key.Enter, new KeyModifiers ()));
			...
			tv.OnKeyPressed (new KeyEventArgs (Key.z, new KeyModifiers ()));
			Assert.Equal ("R0C0", activatedValue);
		...
		public void TableViewMultiSelect_CannotFallOffLeft ()
		{
			...
			tv.SelectedColumn = 1;
			tv.SelectedRow = 1;
			tv.OnKeyPressed (new KeyEventArgs (Key.CursorLeft | Key.ShiftMask, new KeyModifiers { Shift = true }));
		...
		public void TableViewMultiSelect_CannotFallOffRight ()
		{
			...
			tv.SelectedColumn = 0;
			tv.SelectedRow = 1;
			tv.OnKeyPressed (new KeyEventArgs (Key.CursorRight | Key.ShiftMask, new KeyModifiers { Shift = true }));
		...
		public void TableViewMultiSelect_CannotFallOffBottom ()
		{
			...
			tv.SelectedRow = 0;
			tv.OnKeyPressed (new KeyEventArgs (Key.CursorRight | Key.ShiftMask, new KeyModifiers { Shift = true }));
			tv.OnKeyPressed (new KeyEventArgs (Key.CursorDown | Key.ShiftMask, new KeyModifiers { Shift = true }));
		...
		public void TableViewMultiSelect_CannotFallOffTop ()
		{
			...
			tv.SelectedRow = 1;
			tv.OnKeyPressed (new KeyEventArgs (Key.CursorLeft | Key.ShiftMask, new KeyModifiers { Shift = true }));
			tv.OnKeyPressed (new KeyEventArgs (Key.CursorUp | Key.ShiftMask, new KeyModifiers { Shift = true }));
...
";
		...
		public void ScrollDown_OneLineAtATime ()
		{
			...
			// Scroll down
			tableView.OnKeyPressed (new KeyEventArgs () { Key = Key.CursorDown });
...
│1│2│3│";
			...
			// Scroll right
			tableView.OnKeyPressed (new KeyEventArgs () { Key = Key.CursorRight });
...
│2│3│4│";
		...
		public void TestColumnStyle_VisibleFalse_CursorStepsOverInvisibleColumns ()
		{
			...
			tableView.OnKeyPressed (new KeyEventArgs { Key = Key.CursorLeft });
		...
		public void TestColumnStyle_FirstColumnVisibleFalse_CursorStaysAt1 (bool useHome)
		{
			...
			tableView.OnKeyPressed (new KeyEventArgs {
		...
		public void TestColumnStyle_VisibleFalse_MultiSelectingStepsOverInvisibleColumns ()
		{
			...
			tableView.OnKeyPressed (new KeyEventArgs { Key = Key.CursorRight | Key.ShiftMask });
		...
		public void TestToggleCells_MultiSelectOn ()
		{
			...
			// Toggle Select
			tableView.OnKeyPressed (new KeyEventArgs { Key = Key.Space });
			...
			tableView.OnKeyPressed (new KeyEventArgs { Key = Key.CursorRight });
			tableView.OnKeyPressed (new KeyEventArgs { Key = Key.CursorUp });
		...
		public void TestToggleCells_MultiSelectOn_SquareSelectToggled ()
		{
			...
			tableView.OnKeyPressed (new KeyEventArgs { Key = Key.ShiftMask | Key.CursorDown });
			tableView.OnKeyPressed (new KeyEventArgs { Key = Key.ShiftMask | Key.CursorRight });
...
│☐│1│2│";
			...
			// untoggle top one
			tv.OnKeyPressed (new KeyEventArgs (Key.CursorUp, new KeyModifiers ()));
			tv.OnKeyPressed (new KeyEventArgs (Key.Space, new KeyModifiers ()));
...
│☐│1│2│";
		...
		public void TestTableViewCheckboxes_SelectAllToggle ()
		{
			...
			//toggle all cells
			tv.OnKeyPressed (new KeyEventArgs (Key.A | Key.CtrlMask, new KeyModifiers { Ctrl = true }));
			tv.OnKeyPressed (new KeyEventArgs (Key.Space, new KeyModifiers ()));
