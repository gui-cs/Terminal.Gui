...
namespace Terminal.Gui.ViewsTests {
    public class TableViewTests {
        ...
        public void Test_SumColumnWidth_UnicodeLength () {
            ...
            var surrogate = "Les Mise" + Char.ConvertFromUtf32 (Int32.Parse ("0301", NumberStyles.HexNumber))
                                       + "rables";
...
";
        ...
        public void TableView_ColorTests_FocusedOrNot (bool focused) {
            ...
            var setFocusMethod = typeof (View).GetMethod (
                                                          "SetHasFocus",
...
";
            ...
            var invertHotNormal = new Attribute (
                                                 tv.ColorScheme.HotNormal.Background,
                                                 tv.ColorScheme.HotNormal.Foreground);
...
";
            TestHelpers.AssertDriverAttributesAre (
                                                   expected,
                                                   driver: Application.Driver,
                                                   new Attribute[] { tv.ColorScheme.Normal, color });
        }
