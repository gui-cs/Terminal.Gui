...
namespace Terminal.Gui.ViewsTests {
	...
	public class TableViewTests {
		...
		public void PageDown_ExcludesHeaders ()
		{
			...
			tableView.OnKeyPress (new (Key.PageDown));
...
";
		...
		public void TableViewMultiSelect_CannotFallOffLeft ()
		{
			...
			tv.SelectedColumn = 1;
			tv.SelectedRow = 1;
			tv.OnKeyPress (new (Key.CursorLeft | Key.ShiftMask));
		...
		public void TableViewMultiSelect_CannotFallOffRight ()
		{
			...
			tv.SelectedColumn = 0;
			tv.SelectedRow = 1;
			tv.OnKeyPress (new (Key.CursorRight | Key.ShiftMask));
		...
		public void TableViewMultiSelect_CannotFallOffBottom ()
		{
			...
			tv.SelectedRow = 0;
			tv.OnKeyPress (new (Key.CursorRight | Key.ShiftMask));
			tv.OnKeyPress (new (Key.CursorDown | Key.ShiftMask));
		...
		public void TableViewMultiSelect_CannotFallOffTop ()
		{
			...
			tv.SelectedRow = 1;
			tv.OnKeyPress (new (Key.CursorLeft | Key.ShiftMask));
			tv.OnKeyPress (new (Key.CursorUp | Key.ShiftMask));
...
";
		...
		public void ScrollDown_OneLineAtATime ()
		{
			...
			// Scroll down
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.CursorDown });
...
│1│2│3│";
			...
			// Scroll right
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.CursorRight });
...
│2│3│4│";
		...
		public void TestColumnStyle_VisibleFalse_CursorStepsOverInvisibleColumns ()
		{
			...
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.CursorLeft });
		...
		public void TestColumnStyle_FirstColumnVisibleFalse_CursorStaysAt1 (bool useHome)
		{
			...
			tableView.OnKeyPress (new KeyEventArgs () {
		...
		public void TestColumnStyle_VisibleFalse_MultiSelectingStepsOverInvisibleColumns ()
		{
			...
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.CursorRight | Key.ShiftMask });
		...
		public void TestToggleCells_MultiSelectOn ()
		{
			...
			// Toggle Select
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.Space });
			...
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.CursorRight });
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.CursorUp });
		...
		public void TestToggleCells_MultiSelectOn_SquareSelectToggled ()
		{
			...
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.ShiftMask | Key.CursorDown });
			tableView.OnKeyPress (new KeyEventArgs () { Key = Key.ShiftMask | Key.CursorRight });
...
│☐│1│2│";
			...
			tv.OnKeyPress (new (Key.CursorDown));
			tv.OnKeyPress (new (Key.Space));
...
│☐│1│2│";
			...
			// untoggle top one
			tv.OnKeyPress (new (Key.CursorUp));
			tv.OnKeyPress (new (Key.Space));
...
│☐│1│2│";
		...
		public void TestTableViewCheckboxes_SelectAllToggle ()
		{
			...
			//toggle all cells
			tv.OnKeyPress (new (Key.A | Key.CtrlMask));
			tv.OnKeyPress (new (Key.Space));
...
│zoo  │o                                         │";
			...
			// already on fish
			tv.OnKeyPress (new KeyEventArgs () { Key = Key.F });
			Assert.Equal (0, tv.SelectedRow);

			// not focused
			tv.OnKeyPress (new KeyEventArgs () { Key = Key.Z });
			Assert.Equal (0, tv.SelectedRow);
			...
			// move to troll
			tv.OnKeyPress (new KeyEventArgs () { Key = Key.T });
			Assert.Equal (1, tv.SelectedRow);
			...
			Assert.Equal (0, tv.SelectedColumn);
			Assert.Equal (2, tv.SelectedRow);
			tv.OnKeyPress (new KeyEventArgs () { Key = Key.CursorRight });
			Assert.Equal (1, tv.SelectedColumn);
			Assert.Equal (2, tv.SelectedRow);
			...
			tv.OnKeyPress (new KeyEventArgs () { Key = Key.H });
			Assert.Equal (0, tv.SelectedRow);

			// jump to zoo which ends in o
			tv.OnKeyPress (new KeyEventArgs () { Key = Key.O });
			Assert.Equal (3, tv.SelectedRow);
