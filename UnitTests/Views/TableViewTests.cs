...
";
		...
		public void ScrollDown_OneLineAtATime ()
		{
			...
			// Scroll down
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.CursorDown });
...
│1│2│3│";
			...
			// Scroll right
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.CursorRight });
...
│2│3│4│";
		...
		public void TestColumnStyle_VisibleFalse_CursorStepsOverInvisibleColumns ()
		{
			...
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.CursorLeft });
		...
		public void TestColumnStyle_FirstColumnVisibleFalse_CursorStaysAt1 (bool useHome)
		{
			...
			tableView.ProcessKeyDown (new Key () {
		...
		public void TestColumnStyle_VisibleFalse_MultiSelectingStepsOverInvisibleColumns ()
		{
			...
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.CursorRight | ConsoleDriverKey.ShiftMask });
		...
		public void TestToggleCells_MultiSelectOn ()
		{
			...
			// Toggle Select
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.Space });
			...
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.CursorRight });
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.CursorUp });
		...
		public void TestToggleCells_MultiSelectOn_SquareSelectToggled ()
		{
			...
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.ShiftMask | ConsoleDriverKey.CursorDown });
			tableView.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.ShiftMask | ConsoleDriverKey.CursorRight });
...
│zoo  │o                                         │";
			...
			// already on fish
			tv.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.F });
			Assert.Equal (0, tv.SelectedRow);

			// not focused
			tv.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.Z });
			Assert.Equal (0, tv.SelectedRow);
			...
			// move to troll
			tv.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.T });
			Assert.Equal (1, tv.SelectedRow);
			...
			Assert.Equal (0, tv.SelectedColumn);
			Assert.Equal (2, tv.SelectedRow);
			tv.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.CursorRight });
			Assert.Equal (1, tv.SelectedColumn);
			Assert.Equal (2, tv.SelectedRow);
			...
			tv.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.H });
			Assert.Equal (0, tv.SelectedRow);

			// jump to zoo which ends in o
			tv.ProcessKeyDown (new Key () { Key = ConsoleDriverKey.O });
			Assert.Equal (3, tv.SelectedRow);
