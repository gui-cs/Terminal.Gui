...
namespace Terminal.Gui.ViewsTests {
	...
	public class TableViewTests {
		...
		public void PageDown_ExcludesHeaders ()
		{
			...
			tableView.ProcessKeyDown (new (KeyCode.PageDown));
...
";
		...
		public void TableView_Activate ()
		{
			...
			tv.ProcessKeyDown (new (KeyCode.Enter));
			...
			tv.ProcessKeyDown (new (KeyCode.Z));
			Assert.Equal ("R0C0", activatedValue);
		...
		public void TableViewMultiSelect_CannotFallOffLeft ()
		{
			...
			tv.SelectedColumn = 1;
			tv.SelectedRow = 1;
			tv.ProcessKeyDown (new (KeyCode.CursorLeft | KeyCode.ShiftMask));
		...
		public void TableViewMultiSelect_CannotFallOffRight ()
		{
			...
			tv.SelectedColumn = 0;
			tv.SelectedRow = 1;
			tv.ProcessKeyDown (new (KeyCode.CursorRight | KeyCode.ShiftMask));
		...
		public void TableViewMultiSelect_CannotFallOffBottom ()
		{
			...
			tv.SelectedRow = 0;
			tv.ProcessKeyDown (new (KeyCode.CursorRight | KeyCode.ShiftMask));
			tv.ProcessKeyDown (new (KeyCode.CursorDown | KeyCode.ShiftMask));
		...
		public void TableViewMultiSelect_CannotFallOffTop ()
		{
			...
			tv.SelectedRow = 1;
			tv.ProcessKeyDown (new (KeyCode.CursorLeft | KeyCode.ShiftMask));
			tv.ProcessKeyDown (new (KeyCode.CursorUp | KeyCode.ShiftMask));
...
";
		...
		public void ScrollDown_OneLineAtATime ()
		{
			...
			// Scroll down
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.CursorDown });
...
│1│2│3│";
			...
			// Scroll right
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.CursorRight });
...
│2│3│4│";
		...
		public void TestColumnStyle_VisibleFalse_CursorStepsOverInvisibleColumns ()
		{
			...
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.CursorLeft });
		...
		public void TestColumnStyle_FirstColumnVisibleFalse_CursorStaysAt1 (bool useHome)
		{
			...
			tableView.ProcessKeyDown (new KeyEventArgs () {
				ConsoleDriverKey = useHome ? KeyCode.Home : KeyCode.CursorLeft
			});
		...
		public void TestMoveStartEnd_WithFullRowSelect (bool withFullRowSelect)
		{
			...
			tableView.ProcessKeyDown (new KeyEventArgs () {
				ConsoleDriverKey = KeyCode.Home | KeyCode.CtrlMask
			});
		...
		public void TestColumnStyle_LastColumnVisibleFalse_CursorStaysAt2 (bool useEnd)
		{
			...
			tableView.ProcessKeyDown (new KeyEventArgs () {
				ConsoleDriverKey = useEnd ? KeyCode.End : KeyCode.CursorRight
			});
		...
		public void TestColumnStyle_VisibleFalse_MultiSelectingStepsOverInvisibleColumns ()
		{
			...
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.CursorRight | KeyCode.ShiftMask });
		...
		public void TestToggleCells_MultiSelectOn ()
		{
			...
			// Toggle Select
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.Space });
			...
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.CursorRight });
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.CursorUp });
		...
		public void TestToggleCells_MultiSelectOn_SquareSelectToggled ()
		{
			...
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.ShiftMask | KeyCode.CursorDown });
			tableView.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.ShiftMask | KeyCode.CursorRight });
...
│☐│1│2│";
			...
			//toggle the top cell
			tv.ProcessKeyDown (new (KeyCode.Space));
...
│☐│1│2│";
			...
			tv.ProcessKeyDown (new (KeyCode.CursorDown));
			tv.ProcessKeyDown (new (KeyCode.Space));
...
│☐│1│2│";
			...
			// untoggle top one
			tv.ProcessKeyDown (new (KeyCode.CursorUp));
			tv.ProcessKeyDown (new (KeyCode.Space));
...
│☐│1│2│";
		...
		public void TestTableViewCheckboxes_SelectAllToggle ()
		{
			...
			//toggle all cells
			tv.ProcessKeyDown (new (KeyCode.A | KeyCode.CtrlMask));
			tv.ProcessKeyDown (new (KeyCode.Space));
...
│zoo  │o                                         │";
			...
			// already on fish
			tv.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.F });
			Assert.Equal (0, tv.SelectedRow);

			// not focused
			tv.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.Z });
			Assert.Equal (0, tv.SelectedRow);
			...
			// move to troll
			tv.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.T });
			Assert.Equal (1, tv.SelectedRow);
			...
			Assert.Equal (0, tv.SelectedColumn);
			Assert.Equal (2, tv.SelectedRow);
			tv.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.CursorRight });
			Assert.Equal (1, tv.SelectedColumn);
			Assert.Equal (2, tv.SelectedRow);
			...
			tv.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.H });
			Assert.Equal (0, tv.SelectedRow);

			// jump to zoo which ends in o
			tv.ProcessKeyDown (new KeyEventArgs () { ConsoleDriverKey = KeyCode.O });
			Assert.Equal (3, tv.SelectedRow);
