...
public class TileViewTests {
    ...
    public TileViewTests (ITestOutputHelper output) { this._output = output; }
...
└─────┴──────┴─────┘";
    ...
    private TileView Get5x1TilesView (bool border = true) {
        ...
        tv.Tiles.ElementAt (0)
          .ContentView.Add (new Label (new string ('1', 100)) { AutoSize = false, Width = Dim.Fill (), Height = 1 });
        tv.Tiles.ElementAt (1)
          .ContentView.Add (new Label (new string ('2', 100)) { AutoSize = false, Width = Dim.Fill (), Height = 1 });
        tv.Tiles.ElementAt (2)
          .ContentView.Add (new Label (new string ('3', 100)) { AutoSize = false, Width = Dim.Fill (), Height = 1 });
        tv.Tiles.ElementAt (3)
          .ContentView.Add (new Label (new string ('4', 100)) { AutoSize = false, Width = Dim.Fill (), Height = 1 });
        tv.Tiles.ElementAt (4)
          .ContentView.Add (new Label (new string ('5', 100)) { AutoSize = false, Width = Dim.Fill (), Height = 1 });
