...
11111│22222
     │     ";
            ...
            tileView.ProcessKeyDown(new(Key.CursorRight));
...
11111◊22222
     │     ";
            ...
            line.ProcessKeyDown(new(Key.CursorRight));
            tileView.Draw();
...
111111◊2222
      │     ";
            ...
            // and 2 to the left
            line.ProcessKeyDown(new(Key.CursorLeft));
            line.ProcessKeyDown(new(Key.CursorLeft));
            tileView.Draw();
...
22222222222";
            ...
            // Keyboard movement on splitter should have no effect if it is not focused
            var handled = tileView.ProcessKeyDown(new(Key.CursorDown));
...
22222222222";
            ...
            tileView.ProcessKeyDown(new(Key.CursorDown));
...
─────◊─────";
            ...
            // And 2 up
            line.ProcessKeyDown(new(Key.CursorUp));
            line.ProcessKeyDown(new(Key.CursorUp));
            tileView.SetNeedsDisplay();
            tileView.Draw();
            looksLike =
...
22222222222";
            ...
            line.ProcessKeyDown(new(Key.CursorDown));
            tileView.Draw();
            looksLike =
@"    
11111111111
