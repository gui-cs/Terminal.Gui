...
public class TabViewTests {
	...
	TabView GetTabView (out Tab tab1, out Tab tab2, bool initFakeDriver = true)
	{
		...
		tv.AddTab (tab1 = new Tab { DisplayText = "Tab1", View = new TextField { Width = 2, Text = "hi" } },
			false);
...
││ ", _output);
	...
	public void ShowTopLine_True_TabsOnBottom_False_With_Unicode ()
	{
		...
		tab2.DisplayText = "Les Mise" + Char.ConvertFromUtf32 (Int32.Parse ("0301", NumberStyles.HexNumber)) +
				   "rables";
