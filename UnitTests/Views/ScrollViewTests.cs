   ...
   ◄├─┤░░░░►─",
        ...
        private class CustomButton : FrameView {
            ...
            public CustomButton (string fill, string text, int width, int height) : base () {
                ...
                labelFill = new Label ()
                            { AutoSize = false, Width = Dim.Fill (), Height = Dim.Fill (), Visible = false };
...
00000000000000000000000",
        ...
        public void DrawTextFormatter_Respects_The_Clip_Bounds () {
            ...
            view.Add (
                      new Label (rule.Repeat (size.Height / rule.Length), TextDirection.TopBottom_LeftRight)
                      { Height = Dim.Fill (), AutoSize = false });
