...
│└+Route 66    │Great race course      │";
		...
		Application.Top.ProcessHotKey (new OldKeyEvent (Key.CursorRight, new KeyModifiers ()));
...
";
		...
		Application.Top.ProcessHotKey (new OldKeyEvent (Key.CursorLeft, new KeyModifiers ()));
...
";
		...
		tv.ProcessKey(new OldKeyEvent (Key.CursorRight, new KeyModifiers ()));
