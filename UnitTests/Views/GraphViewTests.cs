...
public class GraphViewTests
{
    ...
    public void CellSizeZero ()
    {
        ...
        gv.ContentArea = new Rectangle (0, 0, 50, 30);
    ...
    public static GraphView GetGraph ()
    {
        ...
        gv.MarginBottom = 1;
        gv.MarginLeft = 1;
        gv.ContentArea = new Rectangle (0, 0, 10, 5);
    ...
    public void TestReversing_ScreenToGraphSpace ()
    {
        ...
        for (var x = 0; x < gv.ContentArea.Width; x++)
        {
            for (var y = 0; y < gv.ContentArea.Height; y++)
            {
    ...
    public void ScreenToGraphSpace_DefaultCellSize ()
    {
        ...
        gv.ContentArea = new Rectangle (0, 0, 20, 10);
...
public class LegendTests
{
    ...
    public void Constructors_Defaults ()
    {
        ...
        Assert.Equal (Rectangle.Empty, legend.ContentArea);
        ...
        Assert.Equal (new Rectangle (0, 0, 8, 1), legend.ContentArea);
        Assert.Equal (bounds, legend.Frame);
        Assert.Equal (LineStyle.Single, legend.BorderStyle);
        Assert.False (legend.BeforeSeries);
        legend.BorderStyle = LineStyle.None;
        Assert.Equal (new Rectangle (0, 0, 10, 3), legend.ContentArea);
        Assert.Equal (bounds, legend.Frame);
    }
...
0┼┬┬┬┬┬┬┬┬
 0    5";
    ...
    {
        GraphViewTests.InitFakeDriver ();
        var gv = new GraphView { ColorScheme = new ColorScheme (), ContentArea = new Rectangle (0, 0, 10, 7) };
