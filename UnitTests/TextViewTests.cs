...
namespace Terminal.Gui.Views {
	public class TextViewTests {
		...
		[Fact]
		public void LoadFile_Returns_True_If_File_Exist ()
		{
			var tv = new TextView ();
			var result = tv.LoadFile ("demo.bin");
			Assert.True (result);
		}

		[Fact]
		[AutoInitShutdown]
		public void LoadFile_WordWrap_True ()
		{
			var tv = new TextView () {
				Width = Dim.Fill (),
				Height = Dim.Fill (),
...
Hello world.                                                        
This is a test of the Emergency Broadcast System.                   
0 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 0                             
1 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 1                             
2 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 2                             
3 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 3                             
4 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 4                             
5 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 5                             
6 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 6                             
7 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 7                             
8 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 8                             
9 - This is a test with a very long line and many lines to test the 
ScrollViewBar against the TextView. - 9                             
10 - This is a test with a very long line and many lines to test the
ScrollViewBar against the TextView. - 10                            
11 - This is a test with a very long line and many lines to test the
", output);

			((FakeDriver)Application.Driver).SetBufferSize (40, 25);
			Application.Refresh ();
			Assert.True (tv.WordWrap);
			Assert.False (tv.IsDirty);
			GraphViewTests.AssertDriverContentsWithFrameAre (@"
