...
public class AttributeTests {
	...
	//[Fact]
	//public void Small_Repro_of_Intermittent_TreeViewTests_TestTreeViewColor_Failure ()
	//{
	//	// See https://github.com/gui-cs/Terminal.Gui/issues/2944
	...
	//	// This used to fail because `defaultAttribute.Foreground.ColorName = Color.Blue` changes
	//	// the internal state of the `static readonly Attribute Default` field.
	//	Assert.Equal (Color.White, Attribute.Default.Foreground.ColorName);
	//}

	//[Fact]
	//public void Attribute_ColorName_Cant_Be_Changed ()
	//{
