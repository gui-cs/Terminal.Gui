...
public enum KeyBindingScope {
    ...
    /// <remarks>
    ///     <para>
    ///     Use for Views such as MenuBar and StatusBar which provide commands (shortcuts etc...) that trigger even when not
    ///     focused.
    ///     </para>
    ///     <para>
    ///     HotKey-scoped key bindings are only invoked if the key down event was not handled by the focused view or any of its
    ///     subviews.
    ///     </para>
    /// </remarks>
    /// </summary>
