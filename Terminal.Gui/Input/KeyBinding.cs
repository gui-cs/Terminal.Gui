...
/// <summary>
/// Defines the scope of a <see cref="Command"/> that has been bound to a key with <see cref="KeyBindings.Add(Terminal.Gui.Key, Terminal.Gui.Command[])"/>.
/// </summary>
...
public class KeyBindings {
	...
	/// </para>
	/// <para>
	/// This is a helper function for <see cref="Add(Terminal.Gui.Key,KeyBindingScope,Terminal.Gui.Command[])"/>
	...
	{
		if (key is not (Key.Null or Key.Unknown)) {
