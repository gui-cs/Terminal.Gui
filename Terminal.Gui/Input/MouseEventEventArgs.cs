...
/// <summary>
///     Specifies the event arguments for <see cref="Terminal.Gui.MouseEvent"/>. This is a higher-level construct than the wrapped
///     <see cref="MouseEvent"/> class and is used for the events defined on <see cref="View"/> and subclasses of View (e.g.
///     <see cref="View.MouseEnter"/> and <see cref="View.MouseClick"/>).
/// </summary>
public class MouseEventEventArgs : EventArgs
{
    ...
    /// </summary>
    /// <remarks>
    ///     This property forwards to the <see cref="MouseEvent.Handled"/> property and is provided as a convenience and for backwards compatibility
    /// </remarks>
    public bool Handled
    {
