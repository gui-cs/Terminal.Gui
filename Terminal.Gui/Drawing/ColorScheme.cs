...
public static class Colors {
    ...
    ///             </term>
    ///             <description>
    ///             The dialog color scheme; used for <see cref="Dialog"/>, <see cref="MessageBox"/>, and other views
    ///             dialog-like views.
    ///             </description>
    ///         </item>
    ///         <item>
    ...
    ///     </para>
    ///     <para>
    ///     <see cref="ConfigurationManager"/> can be used to override the default values for these schemes and add additional
    ///     schemes.
