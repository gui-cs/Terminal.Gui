...
namespace Terminal.Gui {
    ...
    public class Thickness : IEquatable<Thickness> {
        ...
        /// </summary>
        public int Vertical { get { return Top + Bottom; } set { Top = Bottom = value / 2; } }

        /// <summary>
        /// Gets the total width of the left and right sides of the rectangle. Sets the width of the left and rigth sides of the
        /// rectangle to half the specified value.
        /// </summary>
        public int Horizontal { get { return Left + Right; } set { Left = Right = value / 2; } }
        ...
        public Rect Draw (Rect rect, string label = null) {
            ...
            if (Top > 0) {
                Application.Driver.FillRect (
                                             new Rect (rect.X, rect.Y, rect.Width, Math.Min (rect.Height, Top)),
                                             topChar);
            }
            ...
            if (Left > 0) {
                Application.Driver.FillRect (
                                             new Rect (rect.X, rect.Y, Math.Min (rect.Width, Left), rect.Height),
                                             leftChar);
            }
