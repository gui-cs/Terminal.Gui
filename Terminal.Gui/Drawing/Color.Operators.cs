...
public readonly partial record struct Color {
    ...
    /// <remarks>
    /// Though this returns a <see cref="Color"/> with <see cref="A"/>, <see cref="R"/>, <see cref="G"/>, and <see cref="B"/>
    /// all set to
    ...
    /// <summary>
    /// Implicit conversion from <see cref="Color"/> to <see langword="int"/> by returning the value of the <see cref="Rgba"/>
    /// field.
    /// </summary>
    [Pure]
    ...
    /// <summary>
    /// Implicit conversion from <see cref="Color"/> to <see langword="uint"/> by returning the value of the <see cref="Argb"/>
    /// field.
    /// </summary>
    [Pure]
    ...
    /// <see cref="Vector4.Y"/>,
    /// <see cref="Vector4.Z"/>, <see cref="Vector4.W"/>) is (<see cref="A"/>,<see cref="R"/>,<see cref="G"/>,<see cref="B"/>),
    /// via
