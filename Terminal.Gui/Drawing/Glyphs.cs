...
///     </para>
///     <para>
///         The JSon property can be either a decimal number or a string. The string may be one of: - A unicode char (e.g.
///         "☑") - A hex value in U+ format (e.g. "U+2611") - A hex value in UTF-16 format (e.g. "\\u2611")
///     </para>
/// </remarks>
