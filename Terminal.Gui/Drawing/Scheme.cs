...
/// <summary>
///     A Scheme is a mapping from <see cref="VisualRole"/>s (such as <see cref="VisualRole.Focus"/>) to <see cref="Attribute"/>s.
...
public record Scheme : IEqualityOperators<Scheme, Scheme, bool>
{
    ...
    /// <summary>The foreground and background attribute for text in a non-focused view that indicates a <see cref="View.HotKey"/>.</summary>
    ...
    /////     attributes adjusted to be more visible.
    ///// </summary>
    ///// <returns></returns>
