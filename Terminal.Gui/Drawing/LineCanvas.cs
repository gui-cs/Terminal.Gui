...
namespace Terminal.Gui {
    ...
    public class LineCanvas : IDisposable {
        ...
        Dictionary<IntersectionRuneType, IntersectionRuneResolver> runeResolvers =
            new Dictionary<IntersectionRuneType, IntersectionRuneResolver> {
                                                                               {
                                                                                   ...
                                                                                   new
                                                                                       LeftTeeIntersectionRuneResolver ()
                                                                               }, {
                                                                                   IntersectionRuneType.RightTee,
                                                                                   new
                                                                                       RightTeeIntersectionRuneResolver ()
                                                                               }, {
                                                                                   IntersectionRuneType.BottomTee,
                                                                                   new
                                                                                       BottomTeeIntersectionRuneResolver ()
                                                                               }, {
