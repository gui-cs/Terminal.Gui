...
internal static class ColorExtensions {
    ...
    /// <summary>Gets or sets a <see cref="FrozenDictionary{TKey,TValue}"/> that maps legacy 16-color values to the corresponding <see cref="ColorName"/>.</summary>
    /// <remarks>Setter should be called as infrequently as possible, as <see cref="FrozenDictionary{TKey,TValue}"/> is expensive to create.</remarks>
