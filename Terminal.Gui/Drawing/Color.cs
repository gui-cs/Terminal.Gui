...
/// <see cref="GetClosestNamedColor"/>). Used with <see cref="Attribute"/>.
/// </summary>
...
public readonly partial record struct Color : ISpanParsable<Color>, IUtf8SpanParsable<Color>, ISpanFormattable, IUtf8SpanFormattable, IMinMaxValue<Color> {
    ...
    /// <remarks>Distance is defined here as the Euclidean distance between each color interpreted as a <see cref="Vector3"/>.<para/>
	...
	/// </summary>
	/// <param name="namedColor">The <see cref="GetClosestNamedColor"/> to check if this <see cref="Color"/> is closer to than any other configured named color.</param>
	...
	/// </summary>
	/// <param name="color">The color to test against the <see cref="GetClosestNamedColor"/> value in <paramref name="namedColor"/>.</param>
	/// <param name="namedColor">The <see cref="GetClosestNamedColor"/> to check if this <see cref="Color"/> is closer to than any other configured named color.</param>
