...
public class Color : IEquatable<Color> {
	...
	// TODO: This should throw an exception of the color is not found.
	/// <summary>
	...
	/// <returns></returns>
	static Color FromColorName (ColorName consoleColor) => _colorToNameMap.FirstOrDefault (x => x.Value == consoleColor).Key;
	...
	public static implicit operator Color (ColorName colorName) => new (colorName);

	/// <summary>
	/// Cast to <see cref="Gui.ColorName"/>. This conversion may lose data and throw an exception.
	/// </summary>
	/// <param name="color"></param>
