...
public struct Rect {
    ...
    /// <remarks>
    ///     Produces a new Rect by inflating an existing Rect by the specified coordinate values. The rectangle is enlarged in
    ///     both directions along an axis.
    /// </remarks>
    ...
    /// <remarks>
    ///     Compares two Rectangle objects. The return value is based on the equivalence of the Location and Size properties of
    ///     the two Rectangles.
    /// </remarks>
    ...
    private bool IntersectsWithInclusive (Rect r) => !(Left > r.Right || Right < r.Left ||
