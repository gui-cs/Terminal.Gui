...
public partial class View {
	...
	/// <remarks>
	///         <para>
	///                 If <see cref="ConsoleDriver.Clip" /> and <see cref="Bounds" /> do not intersect, the clip region will
	///                 be set to
	///                 <see cref="Rect.Empty" />.
	///         </para>
	/// </remarks>
	...
	public void DrawHotString (string text, bool focused, ColorScheme scheme)
	{
		if (focused) {
			...
			DrawHotString (text, Enabled ? scheme.HotNormal : scheme.Disabled,
	...
	///         this view's subviews will be rendered. If <see cref="SuperViewRendersLineCanvas" /> is false (the default),
	///         this
	...
	///         </para>
	///         <para>
	///                 Overrides of <see cref="OnDrawContent(Rect)" /> must ensure they do not set <c>Driver.Clip</c> to a
	///                 clip region
	///                 larger than the <ref name="Bounds" /> property, as this will cause the driver to clip the entire
	///                 region.
	///         </para>
	/// </remarks>
	public void Draw ()
	...
	public virtual void OnDrawContent (Rect contentArea)
	{
		if (NeedsDisplay) {
			...
			TextFormatter?.Draw (BoundsToScreen (contentArea),
				HasFocus ? GetFocusColor () : GetNormalColor (),
				HasFocus ? ColorScheme.HotFocus : GetHotNormalColor (),
				Rect.Empty, TextFormatter.FillRemaining);
	...
	/// <remarks>
	///         <para>
	///                 Will be invoked after any subviews removed with <see cref="Remove(View)" /> have been completed
	///                 drawing.
	///         </para>
	///         <para>
	///                 Rect provides the view-relative rectangle describing the currently visible viewport into the
