...
public partial class View {
    ...
    /// <summary>Gets or sets the <see cref="Gui.TextFormatter"/> used to format <see cref="Text"/>.</summary>
    ...
    ///     <see cref="Direction"/> specified by the <see cref="TextFormatter"/> property and accounting for any
    ...
    public Size GetAutoSize () {
        ...
        int newWidth = rect.Size.Width - GetHotKeySpecifierLength () + (Margin == null
                                                                            ? 0
                                                                            : Margin.Thickness.Horizontal
                                                                              + Border.Thickness.Horizontal
                                                                              + Padding.Thickness.Horizontal);
        int newHeight = rect.Size.Height - GetHotKeySpecifierLength (false) + (Margin == null
                                                                                   ? 0
    ...
    private bool SetFrameToFitText () {
        ...
        bool GetMinimumSizeOfText (out Size sizeRequired) {
            ...
            switch (TextFormatter.IsVerticalDirection (TextDirection)) {
                case true:
                    int colWidth =
                        TextFormatter.GetSumMaxCharWidth (
                                                          new List<string> { TextFormatter.Text },
                                                          0,
                                                          1);
