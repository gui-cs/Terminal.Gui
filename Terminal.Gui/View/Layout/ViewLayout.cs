...
public partial class View {
    ...
    /// </summary>
    public Point GetBoundsOffset () => new (
    ...
    ///     size and position of the view. If either of the <see cref="X"/> and <see cref="Y"/> properties are `null` they will
    ///     be set to <see cref="Pos.PosAbsolute"/> using
