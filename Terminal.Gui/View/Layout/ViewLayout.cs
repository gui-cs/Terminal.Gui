...
public partial class View {
    ...
    /// <summary>Gets or sets a flag that determines whether the View will be automatically resized to fit the <see cref="Text"/> within <see cref="Bounds"/>.
        ...
        (int newLocation, int newDimension) GetNewLocationAndDimension (
            ...
            switch (pos) {
                ...
                case Pos.PosCombine combine:
                    ...
                    int left, right;
                    (left, newDimension) =
                        GetNewLocationAndDimension (width, superviewBounds, combine._left, dim, autosizeDimension);
                    (right, newDimension) =
                        GetNewLocationAndDimension (width, superviewBounds, combine._right, dim, autosizeDimension);
                    if (combine._add) {
    ...
    /// <remarks>TrySetHidth can only be called when AutoSize is true (or being set to true).</remarks>
