...
public class Tile
{
    ...
    /// <summary>
    ///     The <see cref="ContentView"/> that is contained in this <see cref="TileView"/>. Add new child views to this member for multiple
    ...
    /// <summary>
    ///     The text that should be displayed above the <see cref="ContentView"/>. This will appear over the splitter line or border (above the view client area).
    /// </summary>
    ...
    /// <summary>Called before the <see cref="Title"/> changes. Invokes the <see cref="TitleChanging"/> event, which can be cancelled.</summary>
    /// <param name="oldTitle">The <see cref="Title"/> that is/has been replaced.</param>
    /// <param name="newTitle">The new <see cref="Title"/> to be replaced.</param>
    ...
    /// <summary>
    ///     Event fired when the <see cref="Title"/> is changing. Set <see cref="TitleEventArgs.Cancel"/> to <c>true</c> to cancel the Title change.
    /// </summary>
