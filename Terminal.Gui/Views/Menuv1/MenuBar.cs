...
public class MenuBar : View, IDesignable
{
    ...
    public void OpenMenu ()
    {
        ...
        _previousFocused = (SuperView is null ? Application.Running?.Focused : SuperView.Focused)!;
        OpenMenu (_selected);
    ...
    internal void Activate (int idx, int sIdx = -1, MenuBarItem? subMenu = null!)
    {
        ...
        {
            _previousFocused = (SuperView is null ? Application.Running?.Focused ?? null : SuperView.Focused)!;
        }
    ...
    internal Point GetScreenOffset ()
    {
        ...
        View? sv = SuperView ?? Application.Running;
    ...
    internal void OpenMenu (int index, int sIndex = -1, MenuBarItem? subMenu = null!)
    {
        ...
        switch (subMenu)
        {
            case null:
                ...
                _lastFocused ??= SuperView is null ? Application.Running?.MostFocused : SuperView.MostFocused;
