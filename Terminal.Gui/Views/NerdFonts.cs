...
internal class NerdFonts
{
    ...
    /// <summary>
    ///     If <see langword="true"/>, enables the use of Nerd unicode symbols. This requires specific font(s) to be installed on the users machine to work correctly.  Defaults to
    ///     <see langword="false"/>.
    /// </summary>
