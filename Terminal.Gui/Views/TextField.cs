...
public class TextField : View {
    ...
    private bool _isButtonReleased = true;
    private bool _isDrawing;
    private int _preTextChangedCursorPos;
    private CursorVisibility _savedCursorVisibility;
    private int _selectedStart = -1; // -1 represents there is no text selection.
    ...
    private void SetInitialProperties (string text, int w) {
        Height = 1;
