...
public class Wizard : Dialog {
    ...
    void UpdateButtonsAndTitle () {
        ...
        if (CurrentStep == GetLastStep ()) {
            nextfinishBtn.Text = CurrentStep.NextButtonText != string.Empty
    ...
    ///     </item>
    /// </list>
    /// If a non-Modal Wizard is added to the application after <see cref="Application.Run(Func{Exception, bool})"/> has been
    /// called
