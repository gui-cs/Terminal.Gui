...
public class TabStyle {
    ...
    /// <summary>
    ///     True to show the top lip of tabs.  False to directly begin with tab text during rendering.  When true header line
    ///     occupies 3 rows, when false only 2. Defaults to true.
