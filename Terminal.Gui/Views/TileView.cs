namespace Terminal.Gui {
    ...
    public class TileView : View {
        ...
        public override void OnDrawContent (Rect contentArea) {
            ...
            if (IsRootTileView ()) {
                ...
                foreach (var line in allLines) {
                    ...
                    var length = line.Orientation == Orientation.Horizontal ? line.Frame.Width : line.Frame.Height;
        ...
        /// </remarks>
        /// <returns></returns>
        public TileView GetParentTileView () { return this.parentTileView; }
        ...
        private void Setup (Rect contentArea) {
            ...
            for (int i = 0; i < visibleTiles.Length; i++) {
                ...
                if (Orientation == Orientation.Vertical) {
                    ...
                    tile.ContentView.Height =
                        GetTileWidthOrHeight (i, Bounds.Height, visibleTiles, visibleSplitterLines);
                }
            }
        }
        ...
        private Dim GetTileWidthOrHeight (
            int i,
            int space,
            Tile[] visibleTiles,
            TileViewLineView[] visibleSplitterLines
        ) {
            // last tile
            ...
            var nextSplitterPos = Orientation == Orientation.Vertical ? nextSplitter.X : nextSplitter.Y;
            var nextSplitterDistance = nextSplitterPos.Anchor (space);

            var lastSplitter = i >= 1 ? visibleSplitterLines[i - 1] : null;
            var lastSplitterPos = Orientation == Orientation.Vertical ? lastSplitter?.X : lastSplitter?.Y;
        ...
        private class TileViewLineView : LineView {
            ...
            public TileViewLineView (TileView parent, int idx) {
                ...
                this.Parent = parent;
                Idx = idx;
                base.AddCommand (Command.Right, () => { return MoveSplitter (1, 0); });

                base.AddCommand (Command.Left, () => { return MoveSplitter (-1, 0); });

                base.AddCommand (Command.LineUp, () => { return MoveSplitter (0, -1); });

                base.AddCommand (Command.LineDown, () => { return MoveSplitter (0, 1); });
                    ...
                    if (mouseEvent.Flags == MouseFlags.Button1Pressed) {
                        ...
                        if (Orientation == Orientation.Horizontal) { } else {
                            moveRuneRenderLocation = new Point (
                                                                ...
                                                                Math.Max (
                                                                          1,
                                                                          Math.Min (Bounds.Height - 2, mouseEvent.Y)));
                        }
                    }
