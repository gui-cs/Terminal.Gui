...
public class DelegateTreeBuilder<T> : TreeBuilder<T>
{
    ...
    /// <returns></returns>
    public DelegateTreeBuilder (Func<T, IEnumerable<T>> childGetter) : base (false) => _childGetter = childGetter;
    ...
    /// <returns></returns>
    public override bool CanExpand (T toExpand) => _canExpand?.Invoke (toExpand) ?? base.CanExpand (toExpand);
