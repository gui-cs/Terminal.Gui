...
internal class TreeViewCollectionNavigatorMatcher<T> : DefaultCollectionNavigatorMatcher where T : class
{
    ...
    public TreeViewCollectionNavigatorMatcher (TreeView<T> treeView) => _treeView = treeView;
