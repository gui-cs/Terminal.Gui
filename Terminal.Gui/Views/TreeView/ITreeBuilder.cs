...
/// <summary>Interface for supplying data to a <see cref="TreeView{T}"/> on demand as root level nodes are expanded by the user</summary>
public interface ITreeBuilder<T>
{
    ...
    ///     <see cref="GetChildren"/> is an expensive operation otherwise <see cref="SupportsCanExpand"/> should return false (in which case this method will not be called)
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Returns all children of a given <paramref name="forObject"/> which should be added to the tree as new branches underneath it
    /// </summary>
