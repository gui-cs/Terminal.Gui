...
public class GraphCellToRender
{
    ...
    /// <summary>Creates instance and sets <see cref="Rune"/> with custom graph coloring</summary>
    /// <param name="rune"></param>
    /// <param name="color"></param>
    public GraphCellToRender (Rune rune, Attribute color) : this (rune) { Color = color; }

    /// <summary>Creates instance and sets <see cref="Rune"/> and <see cref="Color"/> (or default if null)</summary>
    public GraphCellToRender (Rune rune, Attribute? color) : this (rune) { Color = color; }

    /// <summary>Optional color to render the <see cref="Rune"/> with</summary>
