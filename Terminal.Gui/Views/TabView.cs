...
public class TabView : View
{
    ...
    public void EnsureSelectedTabIsVisible ()
    {
        ...
        if (!CalculateViewport (ContentArea).Any (r => Equals (SelectedTab, r.Tab)))
        {
    ...
    private class TabRowView : View
    {
        ...
        public override void OnDrawContent (Rectangle contentArea)
        {
            _host._tabLocations = _host.CalculateViewport (ContentArea).ToArray ();
        ...
        public override void OnDrawContentComplete (Rectangle contentArea)
        {
            ...
            for (var i = 0; i < tabLocations.Length; i++)
            {
                ...
                Rectangle vts = tab.BoundsToScreen (tab.ContentArea);
                ...
                if (i == tabLocations.Length - 1)
                {
                    ...
                    Rectangle tabsBarVts = BoundsToScreen (ContentArea);
        ...
        private void RenderTabLine ()
        {
            ...
            foreach (TabToRender toRender in tabLocations)
            {
                ...
                tab.TextFormatter.Draw (
                                        tab.BoundsToScreen (tab.ContentArea),
                                        prevAttr,
        ...
        private void RenderUnderline ()
        {
            ...
            if (ShouldDrawRightScrollIndicator ())
            {
                _rightScrollIndicator.X = ContentArea.Width - 1;
