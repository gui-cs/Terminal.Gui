...
namespace Terminal.Gui {
	...
	public partial class FileDialog : Dialog {
		...
		{
			return "-" + Application.Glyphs.RightArrow;
		}

		private string GetBackButtonText ()
		{
			return Application.Glyphs.LeftArrow + "-";
		}
		...
		{
			return isExpanded ?
				new string ((char)Application.Glyphs.LeftArrow, 2) :
				new string ((char)Application.Glyphs.RightArrow, 2);
		}
