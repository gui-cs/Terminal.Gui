...
/// <summary>
///         The <see cref="Dialog" /> <see cref="View" /> is a <see cref="Window" /> that by default is centered and
///         contains one
///         or more <see cref="Button" />s. It defaults to the <c>Colors.ColorSchemes ["Dialog"]</c> color scheme and has a
///         1 cell padding around the edges.
/// </summary>
/// <remarks>
///         To run the <see cref="Dialog" /> modally, create the <see cref="Dialog" />, and pass it to
///         <see cref="Application.Run(Func{Exception, bool})" />.
...
public class Dialog : Window {
	...
	///         <see cref="View.Width" /> and <see cref="View.Height" /> are set
	...
	void LayoutButtons ()
	{
		...
		case ButtonAlignments.Right:
			...
			for (var i = _buttons.Count - 2; i >= 0; i--) {
				var button = _buttons [i];
