    ...
    private void LayoutButtons ()
    {
        ...
        switch (ButtonAlignment)
        {
            case ButtonAlignments.Center:
                // Center Buttons
                shiftLeft = (ContentArea.Width - buttonsWidth - _buttons.Count - 1) / 2 + 1;
                ...
                for (int i = _buttons.Count - 1; i >= 0; i--)
                {
                    ...
                    {
                        button.X = ContentArea.Width - shiftLeft;
                    }
            ...
            case ButtonAlignments.Justify:
                ...
                var spacing = (int)Math.Ceiling ((double)(ContentArea.Width - buttonsWidth) / (_buttons.Count - 1));
