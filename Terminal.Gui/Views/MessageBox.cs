...
public static class MessageBox {
	...
	///         contents.
	/// </remarks>
	public static int Query (int width, int height, string title, string message, int defaultButton = 0,
	...
	/// </remarks>
	public static int Query (int width, int height, string title, string message, int defaultButton = 0,
		bool wrapMessagge = true, params string [] buttons) => QueryFull (false, width, height, title, message,
		defaultButton, wrapMessagge, buttons);
	...
	///         from the size of the message and buttons.
	/// </remarks>
	public static int Query (string title, string message, int defaultButton = 0, bool wrapMessage = true,
		params string [] buttons) =>
	...
	///         the contents.
	/// </remarks>
	public static int ErrorQuery (int width, int height, string title, string message, int defaultButton = 0,
		params string [] buttons) =>
	...
	/// </remarks>
	public static int ErrorQuery (int width, int height, string title, string message, int defaultButton = 0,
		bool wrapMessagge = true, params string [] buttons) => QueryFull (true, width, height, title, message,
		defaultButton, wrapMessagge, buttons);
	...
	///         from the size of the title, message. and buttons.
	/// </remarks>
	public static int ErrorQuery (string title, string message, int defaultButton = 0, bool wrapMessagge = true,
		params string [] buttons) =>
		...
		d.Loaded += (s, e) => {
			...
			if (wrapMessage) {
				messageLabel.TextFormatter.Size = new Size (
					maxBounds.Size.Width - d.GetAdornmentsThickness ().Horizontal,
					maxBounds.Size.Height - d.GetAdornmentsThickness ().Vertical);
			}
