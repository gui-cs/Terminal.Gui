...
public class Shortcut : View
{
    ...
    public Shortcut ()
    {
        ...
        _commandView = new View
        {
            Id = "_commandView",
            CanFocus = false,
            X = 0,//Pos.Align (Alignment.End, AlignmentModes.IgnoreFirstOrLast),
            Y = 0,// Pos.Center (),
        ...
        HelpView = new View
        {
            Id = "_helpView",
            CanFocus = false,
            X = Pos.Right (_commandView), //Pos.Align (Alignment.End, AlignmentModes.IgnoreFirstOrLast),
            Y = 0,// Pos.Center (),
            Width = Dim.Auto (DimAutoStyle.Text),
            Height = Dim.Auto (DimAutoStyle.Text),
        };
        ...
        KeyView = new View
        {
            ...
            X = Pos.Right (HelpView),//Pos.Align (Alignment.End, AlignmentModes.IgnoreFirstOrLast),
            Y = 0,// Pos.Center (),
            Width = Dim.Auto (DimAutoStyle.Text),
            Height = Dim.Auto (DimAutoStyle.Text),
        };
    ...
    public View CommandView
    {
        ...
        set
        {
            ...
            _commandView.X = X = Pos.Align (Alignment.End, AlignmentModes.IgnoreFirstOrLast);
            ...
            HelpView.X = Pos.Right (_commandView);
            _container.Add (_commandView);
            SetSubViewLayout ();
        }
    }
