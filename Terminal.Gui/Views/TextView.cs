...
class TextModel {
    ...
    public static List<List<RuneCell>> StringToLinesOfRuneCells (string content, ColorScheme? colorScheme = null) {
        var cells = content.EnumerateRunes ()
    ...
    (Point current, bool found) GetFoundNextTextPoint (
        string text,
        int linesCount,
        bool matchCase,
        bool matchWholeWord,
    ...
    (Point current, bool found) GetFoundPreviousTextPoint (
        string text,
        int linesCount,
        bool matchCase,
        bool matchWholeWord,
    ...
    public (int col, int row)? WordForward (int fromCol, int fromRow) {
        ...
        try {
            ...
            var lastValidCol = IsSameRuneType (rune, runeType)
...
public class TextView : View {
    ...
    MenuBarItem BuildContextMenuBarItem () => new (
                                                   new MenuItem[] {
                                                                      new (
                                                                           ...
                                                                           null,
                                                                           null,
                                                                           (KeyCode)KeyBindings.GetKeyFromCommands (
                                                                            Command.SelectAll)),
                                                                      new (
    ...
    public override bool MouseEvent (MouseEvent ev) {
        ...
        if (ev.Flags == MouseFlags.Button1Clicked) {
            ...
            if (CurrentColumn == line.Count || CurrentColumn > 0
                && (line[CurrentColumn - 1].Rune.Value != ' ' || line[CurrentColumn].Rune.Value == ' ')) {
