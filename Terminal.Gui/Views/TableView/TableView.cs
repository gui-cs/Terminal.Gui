...
namespace Terminal.Gui {
    ...
    public class TableView : View {
        ...
        public TableView (ITableSource table) : this () { this.Table = table; }
        ...
        public override bool OnProcessKeyDown (Key keyEvent) {
            ...
            if (CollectionNavigator != null &&
                this.HasFocus &&
                Table.Rows != 0 &&
                Gui.CollectionNavigator.IsCompatibleKey (keyEvent) &&
        ...
        /// <summary>
        ///     <para>
        ///     Returns true if the given cell is selected either because it is the active cell or part of a multi cell selection
        ///     (e.g. <see cref="FullRowSelect"/>).
        ///     </para>
