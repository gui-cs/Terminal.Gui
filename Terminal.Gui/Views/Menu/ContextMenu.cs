...
///         <para>
///                 By default, a ContextMenu with sub-menus is displayed in a cascading manner, where each sub-menu pops
///                 out of the ContextMenu frame
///                 (either to the right or left, depending on where the ContextMenu is relative to the edge of the
///                 screen). By setting
///                 <see cref="UseSubMenusSingleFrame" /> to <see langword="true" />, this behavior can be changed such
///                 that all sub-menus are
///                 drawn within the ContextMenu frame.
///         </para>
///         <para>
///                 ContextMenus can be activated using the Shift-F10 key (by default; use the <see cref="Key" /> to change
///                 to another key).
///         </para>
///         <para>
///                 Callers can cause the ContextMenu to be activated on a right-mouse click (or other interaction) by
...
public sealed class ContextMenu : IDisposable {
	...
	///         is less than zero. The default is <see langword="true" /> which means the context menu will be forced to the
	///         right.
	...
	///         ContextMenu
	///         and any sub-menus that would normally cascade will be displayed within a single frame. If
