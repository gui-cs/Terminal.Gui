...
namespace Terminal.Gui
{
    ...
    public class TextValidateField : View
    {
        ...
        protected internal override bool OnMouseEvent  (MouseEvent mouseEvent)
        {
            ...
            {
                int c = _provider.Cursor (mouseEvent.X - GetMargins (ContentArea.Width).left);
        ...
        public override void OnDrawContent (Rectangle contentArea)
        {
            ...
            (int margin_left, int margin_right) = GetMargins (ContentArea.Width);
        ...
        {
            (int left, _) = GetMargins (ContentArea.Width);
            ...
            if (curPos < 0 || curPos >= ContentArea.Width)
            {
                Application.Driver.SetCursorVisibility (CursorVisibility.Invisible);
            }
            else
