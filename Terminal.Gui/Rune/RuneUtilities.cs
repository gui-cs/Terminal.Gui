...
namespace Terminal.Gui {
	internal static class RuneUtilities {
		static int [,] combining = new int [,] {
		...
		static int [,] combiningWideChars = new int [,] {
		...
		public static bool IsNonSpacingChar (int rune)
		{
		...
		public static bool IsWideChar (int rune)
		{
