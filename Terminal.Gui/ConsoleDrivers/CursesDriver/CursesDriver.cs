...
static class Platform {
    [DllImport ("libc")] extern static int uname (IntPtr buf);
    [DllImport ("libc")] extern static int killpg (int pgrp, int pid);
