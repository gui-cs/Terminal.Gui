...
public abstract class ConsoleDriver {
    ...
    public Rect Clip { get => _clip; set => _clip = value; }
...
///     are provided for these (e.g. <see cref="KeyCode.A"/>, <see cref="KeyCode.B"/>, etc.). Even though the values are
///     the same as the ASCII
...
///     with the other key codes to represent shifted keys. For example, the <see cref="KeyCode.A"/> enum value represents
///     the un-shifted 'a' key, while
...
///     </para>
///     <para>
///     All other keys that produce a printable character are encoded as the Unicode value of the character. For example,
///     the <see cref="KeyCode"/>
