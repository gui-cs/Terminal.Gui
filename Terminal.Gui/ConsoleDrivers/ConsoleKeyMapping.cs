...
public static class ConsoleKeyMapping {
    ...
    [DllImport ("user32.dll")] extern static IntPtr GetForegroundWindow ();
    [DllImport ("user32.dll")] extern static IntPtr GetWindowThreadProcessId (IntPtr hWnd, IntPtr ProcessId);
    /// <summary>
    ...
    public static ConsoleKeyInfo GetConsoleKeyInfoFromKeyCode (KeyCode key) {
        ...
        if (isConsoleKey) {
            ...
            var keyChar = GetKeyCharFromUnicodeChar (
                                                     (uint)keyValue,
                                                     modifiers,
                                                     out uint consoleKey,
                                                     out _,
    ...
    static HashSet<ScanCodeMapping> _scanCodes = new HashSet<ScanCodeMapping> {
                                                                                  ...
                                                                                  new (
                                                                                   ...
                                                                                   VK.CLEAR,
                                                                                   0,
                                                                                   '\0'), // Center key (Num Pad 5 with Num Lock off)
                                                                                  new (
                                                                                   76,
                                                                                   VK.CLEAR,
                                                                                   ConsoleModifiers.Shift,
