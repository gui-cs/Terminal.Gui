...
internal class WindowsConsole {
                ...
                ci[i++] = new CharInfo () {
                                              ...
                                              Attributes =
                                                  (ushort)((int)info.Attribute.Foreground.GetClosestNamedColor ()
                                                           | (int)info.Attribute.Background.GetClosestNamedColor ()
                                                           << 4)
                                          };
            }
    ...
    [DllImport ("kernel32.dll", SetLastError = true)] static extern bool SetConsoleActiveScreenBuffer (IntPtr Handle);
...
internal class WindowsDriver : ConsoleDriver {
    ...
    public override void UpdateScreen () {
        ...
        if (!RunningUnitTests && WinConsole != null
...
class WindowsClipboard : ClipboardBase {
    ...
    [DllImport ("kernel32.dll", SetLastError = true)] static extern int GlobalSize (IntPtr handle);
    ...
    [DllImport ("user32.dll", SetLastError = true)] static extern IntPtr SetClipboardData (uint uFormat, IntPtr data);
