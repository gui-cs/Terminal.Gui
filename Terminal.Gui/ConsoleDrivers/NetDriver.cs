...
class NetWinVTConsole {
    ...
    [DllImport ("kernel32.dll", SetLastError = true)] extern static IntPtr GetStdHandle (int nStdHandle);
    [DllImport ("kernel32.dll")] extern static bool GetConsoleMode (IntPtr hConsoleHandle, out uint lpMode);
    [DllImport ("kernel32.dll")] extern static bool SetConsoleMode (IntPtr hConsoleHandle, uint dwMode);
    [DllImport ("kernel32.dll")] extern static uint GetLastError ();
}
