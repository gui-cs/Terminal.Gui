namespace Terminal.Gui {
    ...
    public class TextFormatter {
        ...
        ///     </para>
        ///     <para>
        ///     If <paramref name="preserveTrailingSpaces"/> is <see langword="false"/> at most one space will be preserved at the
        ...
        public static List<string> Format (
            ...
            foreach (var line in WordWrapText (
        ...
        public static int MaxWidth (string text, int maxColumns, int tabWidth = 0) {
            var result = Format (text: text, width: maxColumns, justify: false, wordWrap: true);
            var max = 0;
            result.ForEach (
                            s => {
                                var m = 0;
        ...
        ///     </para>
        ///     <para>
        ///     AutoSize is ignored if <see cref="TextAlignment.Justified"/> and <see cref="VerticalTextAlignment.Justified"/> are
        ///     used.
        ///     </para>
        /// </remarks>
                            ...
                            if (foundIdx > -1) {
                                if (rune.IsCombiningMark ()) {
                                    lastZeroWidthPos[foundIdx] =
                                        (new Point (lastZeroWidthPos[foundIdx].Value.X + 1, current));
