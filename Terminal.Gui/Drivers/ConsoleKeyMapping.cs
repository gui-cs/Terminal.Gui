...
public static class ConsoleKeyMapping
{
    ...
    private static (ConsoleKey consoleKey, char keyChar) MapToConsoleKeyAndChar(KeyCode key, ConsoleModifiers modifiers)
    {
        ...
        {
            ConsoleKey specialKey = (ConsoleKey)(keyValue - (uint)KeyCode.MaxCodePoint);
        ...
        {
            ConsoleKey letterKey = (ConsoleKey)keyValue;
            char letterChar = (char)('a' + (keyValue - (uint)KeyCode.A));
        ...
        {
            ConsoleKey numberKey = (ConsoleKey)keyValue;
            char numberChar;
        ...
        ConsoleKey standardKey = (ConsoleKey)keyValue;
