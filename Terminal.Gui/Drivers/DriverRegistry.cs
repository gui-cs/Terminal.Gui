...
public static class DriverRegistry
{
    ...
    public static IEnumerable<string> GetDriverNames () { return _registry.Keys; }

    /// <summary>
    ///     Gets all registered driver descriptors.
    /// </summary>
    /// <returns>Enumerable of driver descriptors with full metadata.</returns>
    public static IEnumerable<DriverDescriptor> GetDrivers () { return _registry.Values; }
    ...
    public static bool TryGetDriver (string name, out DriverDescriptor? descriptor) { return _registry.TryGetValue (name, out descriptor); }
    ...
    public static bool IsRegistered (string name) { return _registry.ContainsKey (name); }
    ...
    public static DriverDescriptor GetDefaultDriver ()
    {
        ...
        {
            return _registry [Names.WINDOWS];
        }
