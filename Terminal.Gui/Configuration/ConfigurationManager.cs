    ...
    internal static void Initialize () {
        ...
        var types = from assembly in AppDomain.CurrentDomain.GetAssemblies ()
                    ...
                    where type.GetProperties ()
                              .Any (
                                    prop => prop.GetCustomAttribute (typeof (SerializableConfigurationProperty))
                                            != null)
                    select type;
        ...
        foreach (var p in from c in classesWithConfigProps
                          let props = c.Value.GetProperties (
                                       ...
                                       .Where (
                                               prop =>
                                                   prop.GetCustomAttribute (typeof (SerializableConfigurationProperty))
                                                       is SerializableConfigurationProperty)
