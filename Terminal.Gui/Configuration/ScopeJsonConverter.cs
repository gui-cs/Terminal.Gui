...
/// <summary>
///     Converts <see cref="Scope{T}"/> instances to/from JSON. Does all the heavy lifting of reading/writing config data to/from
///     <see cref="ConfigurationManager"/> JSON documents.
/// </summary>
