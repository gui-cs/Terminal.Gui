...
public static class InputInjectionExtensions
{
    ...
    public static void InjectKey (this IApplication app, Key key) { app.GetInputInjector ().InjectKey (key); }
    ...
    public static void InjectMouse (this IApplication app, Mouse mouseEvent) { app.GetInputInjector ().InjectMouse (mouseEvent); }
