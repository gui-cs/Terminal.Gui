...
{
    /// <summary>
    ///     Directly converts this <see cref="DimAutoStyle"/> value to an <see langword="int"/> value with the
    ...
    /// <summary>
    ///     Directly converts this <see cref="DimAutoStyle"/> value to a <see langword="uint"/> value with the
    ///     same binary representation.
    /// </summary>
    /// <remarks>NO VALIDATION IS PERFORMED!</remarks>
    [MethodImpl (MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    ///     Determines if the specified flags are set in the current value of this <see cref="DimAutoStyle"/>
    ///     .
    /// </summary>
    /// <remarks>NO VALIDATION IS PERFORMED!</remarks>
    /// <returns>
    ///     True, if all flags present in <paramref name="checkFlags"/> are also present in the current value of the
    ///     <see cref="DimAutoStyle"/>.<br/>Otherwise false.
    /// </returns>
    [MethodImpl (MethodImplOptions.AggressiveInlining)]
    ...
    ///     <see cref="DimAutoStyle"/>.
    /// </summary>
    /// <param name="e">The <see cref="DimAutoStyle"/> value to check against the <paramref name="mask"/> value.</param>
    ...
    ///     <see cref="DimAutoStyle"/> <see langword="enum"/> type.
    /// </summary>
    /// <remarks>
