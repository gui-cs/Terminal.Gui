...
/// <summary>Extension methods for the <see cref="Dimension"/> <see langword="enum"/> type.</summary>
...
{
    /// <summary>
    ///     Directly converts this <see cref="Dimension"/> value to an <see langword="int"/> value with the same
    ...
    /// <summary>
    ///     Directly converts this <see cref="Dimension"/> value to a <see langword="uint"/> value with the same
    ///     binary representation.
    /// </summary>
    /// <remarks>NO VALIDATION IS PERFORMED!</remarks>
    [MethodImpl (MethodImplOptions.AggressiveInlining)]
    ...
    ///     <see cref="Dimension"/> <see langword="enum"/> type.
    /// </summary>
    /// <remarks>
