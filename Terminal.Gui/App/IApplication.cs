...
public interface IApplication
{
    ...
    ///     <para>
    ///         This is equivalent to calling <see cref="RequestStop(Toplevel)"/> with <see cref="Running"/> as the parameter.
    ///     </para>
    /// </remarks>
    void RequestStop ();
    ...
    /// <summary>Requests that the currently running Session stop. The Session will stop after the current iteration completes.</summary>
    /// <param name="top">
    ///     The <see cref="Toplevel"/> to stop. If <see langword="null"/>, stops the currently running <see cref="Running"/>.
    /// </param>
    /// <remarks>
    ///     <para>This will cause <see cref="Run(Toplevel, Func{Exception, bool})"/> to return.</para>
    ///     <para>
    ...
    /// <summary>Gets or sets the currently running Toplevel.</summary>
    /// <remarks>
    ///     <para>
    ///         This is set by <see cref="Begin(Toplevel)"/> and cleared by <see cref="End(SessionToken)"/>.
    ///     </para>
    /// </remarks>
    Toplevel? Running { get; set; }
    ...
    ///         has no SuperView (e.g. when <see cref="Running"/> is moved or resized).
    ///     </para>
    ///     <para>
