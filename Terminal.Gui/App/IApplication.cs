...
public interface IApplication
{
    ...
    /// <remarks>
    ///     <para>
    ///         This method prepares the provided <see cref="Toplevel"/> for running with the focus. It adds this to the
    ...
    ///     </para>
    ///     <para>
    ///         Raises the <see cref="NotifyNewRunState"/> event before returning.
    ///     </para>
    /// </remarks>
    ...
    /// <summary>
    ///     Runs the application by creating a <see cref="Toplevel"/>-derived object of type <typeparamref name="TView"/>
    ///     and calling <see cref="Run(Toplevel, Func{Exception, bool})"/>.
    /// </summary>
    ...
    /// <remarks>
    ///     <para>
    ///         This method removes the <see cref="Toplevel"/> from the stack, raises the <see cref="NotifyStopRunState"/>
    ///         event, and disposes the <paramref name="runState"/>.
    ///     </para>
    /// </remarks>
    public void End (RunState runState);

    /// <summary>Requests that the currently running <see cref="Top"/> stop running.</summary>
    /// <remarks>
    ...
    /// <summary>Stops the provided <see cref="Toplevel"/>.</summary>
    /// <param name="top">
    ...
    /// <remarks>
    ///     <para>
    ///         This is set by <see cref="Begin(Toplevel)"/> and cleared by <see cref="End(RunState)"/>.
    ///     </para>
    /// </remarks>
    ...
    /// <remarks>
    ///     <para>
    ///         Toplevels are added to this stack by <see cref="Begin(Toplevel)"/> and removed by <see cref="End(RunState)"/>.
    ///     </para>
    /// </remarks>
