...
namespace Terminal.Gui {
    internal class FileDialogHistory {
        ...
        internal bool CanBack () { return this.back.Count > 0; }
        ...
        internal bool CanUp () { return this.dlg.State?.Directory.Parent != null; }
        ...
        internal bool CanForward () { return this.forward.Count > 0; }
        internal void ClearForward () { this.forward.Clear (); }
    }
}
