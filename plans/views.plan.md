...
- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/views.md`
- Current size: 1122 lines
...
## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/Views`.
...
- [ ] Validate and correct all xrefs (149 markers detected); use `<xref:...>` where possible.
