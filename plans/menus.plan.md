...
- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/menus.md`
- Current size: 721 lines

## Current Signals
- Em-dashes: 13
- Horizontal separators (`---`): 10
- Mermaid blocks: 0
- xref markers: 132
- C# code blocks: 13

## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/Views/Menu`.
...
- [ ] Remove all horizontal separators (`---`) in this document (10 found).
- [ ] Replace all em-dashes with semicolons or parentheses (13 found).
- [ ] Validate and correct all xrefs (132 markers detected); use `<xref:...>` where possible.
- [ ] Update all C# examples (13 block(s)) to repository style and C# 14 conventions.
