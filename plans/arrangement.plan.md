# Plan for arrangement.md

- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/arrangement.md`
- Current size: 741 lines

## Current Signals
- Em-dashes: 0
- Horizontal separators (`---`): 13
- Mermaid blocks: 0
- xref markers: 8
- C# code blocks: 23

## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/ViewBase/Layout and /home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/ViewBase/Adornment`.
...
- [ ] Remove all horizontal separators (`---`) in this document (13 found).
- [ ] Confirm no em-dashes are introduced.
- [ ] Validate and correct all xrefs (8 markers detected); use `<xref:...>` where possible.
- [ ] Update all C# examples (23 block(s)) to repository style and C# 14 conventions.
