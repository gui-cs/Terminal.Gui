# Plan for scrolling.md

- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/scrolling.md`
...
## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/ViewBase and /home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/Views`.
...
- [ ] Validate and correct all xrefs (13 markers detected); use `<xref:...>` where possible.
- [ ] Update all C# examples (2 block(s)) to repository style and C# 14 conventions.
