# Plan for tableview.md

- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/tableview.md`
...
## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/Views/TableView`.
...
- [ ] Update all C# examples (4 block(s)) to repository style and C# 14 conventions.

## File-Specific Notes
- Add API xrefs for TableView, ITableSource, DataTableSource, and related table source types.
