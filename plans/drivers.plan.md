...
- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/drivers.md`
- Current size: 515 lines
...
## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/Drivers`.
...
- [ ] Replace all em-dashes with semicolons or parentheses (5 found).
- [ ] Validate and correct all xrefs (17 markers detected); use `<xref:...>` where possible.
- [ ] Update all C# examples (11 block(s)) to repository style and C# 14 conventions.
