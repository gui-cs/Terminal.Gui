...
- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/View.md`
- Current size: 802 lines

## Current Signals
- Em-dashes: 4
- Horizontal separators (`---`): 12
- Mermaid blocks: 0
- xref markers: 41
- C# code blocks: 18

## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/ViewBase`.
...
- [ ] Remove all horizontal separators (`---`) in this document (12 found).
- [ ] Replace all em-dashes with semicolons or parentheses (4 found).
- [ ] Validate and correct all xrefs (41 markers detected); use `<xref:...>` where possible.
- [ ] Update all C# examples (18 block(s)) to repository style and C# 14 conventions.
