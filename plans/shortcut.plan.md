# Plan for shortcut.md

- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/shortcut.md`
...
## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/Views/Shortcut.cs`.
...
- [ ] Replace all em-dashes with semicolons or parentheses (3 found).
- [ ] Validate and correct all xrefs (60 markers detected); use `<xref:...>` where possible.
- [ ] Update all C# examples (5 block(s)) to repository style and C# 14 conventions.
