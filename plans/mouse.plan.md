...
- Document: `/home/runner/work/Terminal.Gui/Terminal.Gui/docfx/docs/mouse.md`
...
## Planned Actions
- [ ] Verify technical claims against source code in: `/home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/Input/Mouse and /home/runner/work/Terminal.Gui/Terminal.Gui/Terminal.Gui/Drivers/Mouse`.
...
- [ ] Validate and correct all xrefs (14 markers detected); use `<xref:...>` where possible.
- [ ] Update all C# examples (35 block(s)) to repository style and C# 14 conventions.
