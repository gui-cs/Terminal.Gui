...
Terminal.Gui provides comprehensive logging of library internals via the <xref:Terminal.Gui.App.Logging> class. Logging helps diagnose issues with terminals, keyboard layouts, drivers, and platform-specific behavior.
...
The <xref:Terminal.Gui.App.Logging> class provides:
