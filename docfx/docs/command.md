...
| **Mouse → Command Pipeline** | See [Mouse Pipeline](mouse.md#complete-mouse-event-pipeline)<br>**Current:** `Button1Clicked` → `Activate`<br>**Recommended:** `Button1Clicked` → `Activate` (first click)<br>`Button1DoubleClicked` → `Accept` (framework-provided) | See [Mouse Pipeline](mouse.md#complete-mouse-event-pipeline)<br>**Current:** Applications track timing manually<br>**Recommended:** `Button1DoubleClicked` → `Accept` |
