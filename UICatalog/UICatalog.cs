			...
			public UICatalogTopLevel ()
			{
				...
				MenuBar = new MenuBar (new MenuBarItem [] {
					...
					new MenuBarItem ("_Help", new MenuItem [] {
						new MenuItem ("_Documentation", "", () => OpenUrl ("https://gui-cs.github.io/Terminal.GuiV2Docs"), null, null, KeyCode.F1),
						new MenuItem ("_README", "", () => OpenUrl ("https://github.com/gui-cs/Terminal.Gui"), null, null, KeyCode.F2),
						new MenuItem ("_About...",
				...
				StatusBar.Items = new StatusItem [] {
					...
					new StatusItem(KeyCode.F10, "~F10~ Status Bar", () => {
