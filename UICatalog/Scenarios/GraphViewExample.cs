...
public class GraphViewExample : Scenario {
    ...
    private void SetupDisco () {
        ...
        List<BarSeriesBar> bars = new List<BarSeriesBar> ();
        ...
        _graphView.Series.Add (
                               new ScatterSeries {
                                                     Points = new List<PointF> {
                                                                                   ...
                                                                                   new (13, 26.982f), new (14, 28.086f),
                                                                                   new (15, 30.974f), new (16, 32.065f),
                                                                                   new (17, 35.453f), new (18, 39.948f),
                                                                                   new (19, 39.098f), new (20, 40.078f),
                                                                                   new (21, 44.956f), new (22, 47.867f),
                                                                                   new (23, 50.942f), new (24, 51.996f),
                                                                                   new (25, 54.938f), new (26, 55.845f),
                                                                                   new (27, 58.933f), new (28, 58.693f),
                                                                                   new (29, 63.546f), new (30, 65.38f),
                                                                                   new (31, 69.723f), new (32, 72.64f),
                                                                                   new (33, 74.922f), new (34, 78.96f),
                                                                                   new (35, 79.904f), new (36, 83.798f),
                                                                                   new (37, 85.468f), new (38, 87.62f),
                                                                                   new (39, 88.906f), new (40, 91.224f),
                                                                                   new (41, 92.906f), new (42, 95.96f),
                                                                                   new (43, 98f), new (44, 101.07f),
                                                                                   new (45, 102.906f),
                                                                                   new (46, 106.42f),
                                                                                   new (47, 107.868f),
                                                                                   new (48, 112.411f),
...
100+,3016,12818*/
        ...
        _graphView.Annotations.Add (
                                    new TextAnnotation
                                    { Text = "F", ScreenPosition = new Point (_graphView.Bounds.Width - 1, 10) });
