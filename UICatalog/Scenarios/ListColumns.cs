...
public class ListColumns : Scenario {
		...
		var menu = new MenuBar {
			Menus = [
				...
				new MenuBarItem ("_View", new [] {
					...
					_miExpandLastColumn = new MenuItem ("_ExpandLastColumn", "",
					...
					_miSmoothScrolling = new MenuItem ("_SmoothHorizontalScrolling", "",
						() => ToggleSmoothScrolling ()) {
						Checked = _listColView.Style.SmoothHorizontalScrolling,
						CheckType = MenuItemCheckStyle.Checked
					},
					_miAlternatingColors = new MenuItem ("Alternating Colors", "",
				...
				new MenuBarItem ("_List", new [] {
					//new MenuItem ("_Hide Headers", "", HideHeaders),
					_miOrientVertical = new MenuItem ("_OrientVertical", "",
						() => ToggleVerticalOrientation ()) {
						Checked = listColStyle.Orientation == Orientation.Vertical,
						CheckType = MenuItemCheckStyle.Checked
					},
					_miScrollParallel = new MenuItem ("_ScrollParallel", "",
	...
	void ToggleAlternatingColors ()
	{
		...
		if (_miAlternatingColors.Checked == true) {
			_listColView.Style.RowColorGetter = a => {
	...
	/// <summary>
	///         Builds a simple list in which values are the index.  This helps testing that scrolling etc is working correctly
	///         and not
