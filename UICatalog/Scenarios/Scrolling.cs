        ...
        public override void Setup () {
            ...
            void Top_Loaded (object sender, EventArgs args) {
                horizontalRuler.Text =
                    ...
                    "\n" + "|         ".Repeat (
                                                (int)Math.Ceiling (
                                                                   (double)(horizontalRuler.Bounds.Width)
                                                                   / (double)rule.Length))[0..(horizontalRuler.Bounds
                                    .Width)];
                verticalRuler.Text =
            ...
            scrollView.Add (
                            new TextField ("This is a test of...") {
                                                                       X = 3,
                                                                       Y = 5,
                                                                       Width = 50,
            ...
            scrollView.Add (
                            new TextField ("... the emergency broadcast system.") {
                                X = 3,
                                Y = 10,
                                Width = 50,
                                ColorScheme = Colors.ColorSchemes["Dialog"]
