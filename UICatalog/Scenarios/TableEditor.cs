    ...
    public class TableEditor : Scenario {
        ...
        private void OpenTreeExample () {
            ...
            var tree = new TreeView<FileSystemInfo> {
                                                        ...
                                                        TreeBuilder =
                                                            new DelegateTreeBuilder<FileSystemInfo> (GetChildren)
                                                    };

            var source = new TreeTableSource<FileSystemInfo> (
                                                              tableView,
                                                              "Name",
                                                              tree,
                                                              new () {
        ...
        private void EditCurrentCell (object sender, CellActivatedEventArgs e) {
            ...
            if (okPressed) {
                try {
                    currentTable.Rows[e.Row][tableCol] =
                        string.IsNullOrWhiteSpace (tf.Text) ? DBNull.Value : (object)tf.Text;
                }
                catch (Exception ex) {
        ...
        public static DataTable BuildDemoDataTable (int cols, int rows) {
            ...
            for (int i = 0; i < rows; i++) {
                List<object> row = new List<object> () {
                                                           ...
                                                           r.Next (i),
                                                           (r.NextDouble () * i)
                                                           - 0.5 /*add some negatives to demo styles*/,
                                                           DBNull.Value,
                                                           "Les Mise" + Char.ConvertFromUtf32 (
                                                            Int32.Parse ("0301", NumberStyles.HexNumber)) + "rables"
                                                       };
