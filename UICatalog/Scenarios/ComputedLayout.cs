        ...
        public override void Setup () {
            ...
            Application.Top.LayoutComplete += (s, a) => {
                horizontalRuler.Text =
                    rule.Repeat ((int)Math.Ceiling ((double)(horizontalRuler.Bounds.Width) / (double)rule.Length))
                        [0..(horizontalRuler.Bounds.Width)];
                verticalRuler.Text =
                    vrule.Repeat ((int)Math.Ceiling ((double)(verticalRuler.Bounds.Height * 2) / (double)rule.Length))
                        [0..(verticalRuler.Bounds.Height * 2)];
            };
            ...
            labelList.Add (
                           new Label ($"{i++}-{txt}") {
                                                          TextAlignment = TextAlignment.Left, Width = Dim.Fill (),
                                                          X = 0,
            ...
            labelList.Add (
                           new Label ($"{i++}-{txt}") {
                                                          TextAlignment = TextAlignment.Right, Width = Dim.Fill (),
                                                          X = 0,
                                                          Y = Pos.Bottom (labelList.LastOrDefault ()),
                                                          ColorScheme = Colors.ColorSchemes["Dialog"]
                                                      });
            labelList.Add (
                           new Label ($"{i++}-{txt}") {
                                                          TextAlignment = TextAlignment.Centered, Width = Dim.Fill (),
                                                          X = 0,
                                                          Y = Pos.Bottom (labelList.LastOrDefault ()),
                                                          ColorScheme = Colors.ColorSchemes["Dialog"]
                                                      });
            labelList.Add (
                           new Label ($"{i++}-{txt}") {
                                                          TextAlignment = TextAlignment.Justified, Width = Dim.Fill (),
                                                          X = 0,
                                                          Y = Pos.Bottom (labelList.LastOrDefault ()),
                                                          ColorScheme = Colors.ColorSchemes["Dialog"]
                                                      });
