...
public class ComputedLayout : Scenario {
	...
	public override void Setup ()
	{
		...
		labelList.Add (new Label { Text = $"{i++}-{txt}", AutoSize = false, TextAlignment = TextAlignment.Left, Width = Dim.Fill (), X = 0, Y = Pos.Bottom (labelList.LastOrDefault ()), ColorScheme = Colors.ColorSchemes ["Dialog"] });
		labelList.Add (new Label { Text = $"{i++}-{txt}", AutoSize = false, TextAlignment = TextAlignment.Right, Width = Dim.Fill (), X = 0, Y = Pos.Bottom (labelList.LastOrDefault ()), ColorScheme = Colors.ColorSchemes ["Dialog"] });
		labelList.Add (new Label { Text = $"{i++}-{txt}", AutoSize = false, TextAlignment = TextAlignment.Centered, Width = Dim.Fill (), X = 0, Y = Pos.Bottom (labelList.LastOrDefault ()), ColorScheme = Colors.ColorSchemes ["Dialog"] });
		labelList.Add (new Label { Text = $"{i++}-{txt}", AutoSize = false, TextAlignment = TextAlignment.Justified, Width = Dim.Fill (), X = 0, Y = Pos.Bottom (labelList.LastOrDefault ()), ColorScheme = Colors.ColorSchemes ["Dialog"] });
