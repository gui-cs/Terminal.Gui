...
namespace UICatalog.Scenarios {
    [ScenarioMetadata (
                          Name: "Single BackgroundWorker",
                          Description: "A single BackgroundWorker threading opening another Toplevel")]
    ...
    public class SingleBackgroundWorker : Scenario {
        ...
        public class MainApp : Toplevel {
            ...
            private void RunWorker () {
                ...
                md.Add (
                        new Label ("Wait for worker to finish...") {
                                                                       X = Pos.Center (),
                                                                       Y = Pos.Center ()
                                                                   });
