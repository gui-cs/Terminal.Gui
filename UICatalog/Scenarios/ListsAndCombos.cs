...
namespace UICatalog.Scenarios {
    [ScenarioMetadata (
                          Name: "ListView & ComboBox",
                          Description: "Demonstrates a ListView populating a ComboBox that acts as a filter.")]
    ...
    public class ListsAndCombos : Scenario {
        public override void Setup () {
            ...
            listview.SelectedItemChanged += (object s, ListViewItemEventArgs e) =>
                lbListView.Text = items[listview.SelectedItem];
            ...
            comboBox.SelectedItemChanged += (object s, ListViewItemEventArgs text) =>
