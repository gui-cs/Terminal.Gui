...
public class CharacterMap : Scenario {
    ...
    public override void Setup () {
        ...
        var jumpEdit = new TextField () {
                                            X = Pos.Right (jumpLabel) + 1, Y = Pos.Y (_charMap), Width = 10,
                                            Caption = "e.g. 01BE3"
                                        };
        Application.Top.Add (jumpEdit);
        _errorLabel = new Label ("err") {
                                            X = Pos.Right (jumpEdit) + 1, Y = Pos.Y (_charMap),
...
class CharMap : ScrollView {
    ...
    public CharMap () {
        ...
        ContentSize = new Size (
                                RowWidth,
                                (int)((MaxCodePoint / 16 + (ShowHorizontalScrollIndicator ? 2 : 1)) * _rowHeight));
