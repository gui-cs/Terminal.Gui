...
namespace UICatalog.Scenarios {
	...
	public class ButtonsEffect3D : Scenario {
		public override void Setup ()
		{
			...
			buttonRightBottomEffect3D.Add (new Button ("Button 3") {
				X = 2,
				Y = 1,
				Border = new Border {
					Effect3D = true,
			...
			buttonRightBottomEffect3D.Add (new Button ("Button 4") {
				X = 20,
				Y = 1,
				Border = new Border {
					Effect3D = true,
			...
			buttonRightTopEffect3D.Add (new Button ("Button 5") {
				X = 2,
				Y = 1,
				Border = new Border {
					Effect3D = true,
			...
			buttonRightTopEffect3D.Add (new Button ("Button 6") {
				X = 20,
				Y = 1,
				Border = new Border {
					Effect3D = true,
			...
			buttonLeftTopEffect3D.Add (new Button ("Button 7") {
				X = 2,
				Y = 1,
				Border = new Border {
					Effect3D = true,
			...
			buttonLeftTopEffect3D.Add (new Button ("Button 8") {
				X = 20,
				Y = 1,
				Border = new Border {
					Effect3D = true,
			...
			buttonLeftBottomEffect3D.Add (new Button ("Button 9") {
				X = 2,
				Y = 1,
				Border = new Border {
					Effect3D = true,
			...
			buttonLeftBottomEffect3D.Add (new Button ("Button 0") {
				X = 20,
				Y = 1,
				Border = new Border {
					Effect3D = true,
