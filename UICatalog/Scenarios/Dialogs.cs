    ...
    )
    {
        ...
        try
        {
            ...
            dialog = new ()
            {
                ...
                Text = "Dialog Text",
                ButtonAlignment = (Alignment)Enum.Parse (typeof (Alignment), alignmentRadioGroup.RadioLabels [alignmentRadioGroup.SelectedItem.HasValue ? alignmentRadioGroup.SelectedItem.Value : 0].Substring (1)),
