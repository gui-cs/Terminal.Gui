			...
			for (var i = 0; i < render.Length; i++) {
				...
				if (rainbows != -1 && i >= rainbows && i <= rainbows + 8) {
					...
					case 0:
						...
						break;
					case 1:
						Driver.SetAttribute (new Attribute (Color.BrightRed,
							cellColor.Background));
						break;
					case 2:
						Driver.SetAttribute (new Attribute (Color.BrightYellow,
							cellColor.Background));
						break;
					case 3:
						...
						break;
					case 4:
						Driver.SetAttribute (new Attribute (Color.BrightGreen,
							cellColor.Background));
						break;
					case 5:
						Driver.SetAttribute (new Attribute (Color.BrightBlue,
							cellColor.Background));
						break;
					case 6:
						Driver.SetAttribute (new Attribute (Color.BrightCyan,
							cellColor.Background));
						break;
					case 7:
