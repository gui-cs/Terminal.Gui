...
public class GetViewsUnderLocationTests
{
    ...
    )
    {
        ...
        Application.Running.Margin!.Thickness = new (marginThickness);
        Application.Running.Margin!.Id = "Margin";
        Application.Running.Border!.Thickness = new (borderThickness);
        Application.Running.Border!.Id = "Border";
        Application.Running.Padding!.Thickness = new (paddingThickness);
        Application.Running.Padding.Id = "Padding";

        var location = new Point (testX, testY);

        // Act
        List<View?> viewsUnderMouse = Application.Running.GetViewsUnderLocation (location, ViewportSettingsFlags.TransparentMouse);
    ...
    public void Returns_Top_If_No_SubViews (int testX, int testY)
    {
        ...
        // Assert
        Assert.Contains (viewsUnderMouse, v => v == Application.Running);
        Application.Running.Dispose ();
        Application.ResetState (true);
    }
    ...
    public void Returns_Start_If_No_SubViews (int testX, int testY)
    {
        ...
        Assert.Same (Application.Running, Application.Running.GetViewsUnderLocation (new (testX, testY), ViewportSettingsFlags.TransparentMouse).LastOrDefault ());
        Application.Running.Dispose ();
        Application.ResetState (true);
    }
    ...
    public void Returns_Correct_If_SubViews (int testX, int testY, bool expectedSubViewFound)
    {
        ...
        Application.Running.Add (subview);

        View? found = Application.Running.GetViewsUnderLocation (new (testX, testY), ViewportSettingsFlags.TransparentMouse).LastOrDefault ();
    ...
    public void Returns_Null_If_Not_Visible_And_SubView_Visible (int testX, int testY, bool expectedSubViewFound)
    {
        ...
        Assert.False (Application.Running.Visible);
        View? found = Application.Running.GetViewsUnderLocation (new (testX, testY), ViewportSettingsFlags.TransparentMouse).LastOrDefault ();
    ...
    public void Returns_Correct_If_Start_Has_Adornments (int testX, int testY, bool expectedSubViewFound)
    {
        ...
        Application.Running.Margin!.Thickness = new (1);
    ...
    public void Returns_Correct_If_Start_Has_Offset_Viewport (int offset, int testX, int testY, bool expectedSubViewFound)
    {
        ...
        Application.Running.Viewport = new (offset, offset, 10, 10);
    ...
    public void Returns_Correct_If_Start_Has_Adornment_WithSubView (int testX, int testY, bool expectedSubViewFound)
    {
        ...
        Application.Running.Padding!.Thickness = new (1);
    ...
    public void Returns_Adornment_If_Start_Has_Adornments (int testX, int testY, string [] expectedViewsFound)
    {
        ...
        Application.Running.Margin!.Thickness = new (1);
        Application.Running.Margin!.Id = "Margin";
        Application.Running.Border!.Thickness = new (1);
        Application.Running.Border!.Id = "Border";
        Application.Running.Padding!.Thickness = new (1);
        Application.Running.Padding.Id = "Padding";
        ...
        List<View?> viewsUnderMouse = Application.Running.GetViewsUnderLocation (new (testX, testY), ViewportSettingsFlags.TransparentMouse);
        string [] foundIds = viewsUnderMouse.Select (v => v!.Id).ToArray ();
    ...
    public void Returns_Correct_With_NestedSubViews (int testX, int testY, int expectedSubViewFound)
    {
        ...
        Application.Running.Add (subviews [0]);
    ...
    public void Tiled_SubViews (int mouseX, int mouseY, string [] viewIdStrings)
    {
        ...
        List<View?> found = Application.Running.GetViewsUnderLocation (new (mouseX, mouseY), ViewportSettingsFlags.TransparentMouse);
    ...
    public void Returns_TopToplevel_When_Point_Inside_Only_TopToplevel ()
    {
        ...
        Application.Running = secondaryToplevel;

        List<View?> found = Application.Running.GetViewsUnderLocation (new (2, 2), ViewportSettingsFlags.TransparentMouse);
    ...
    public void Returns_SecondaryToplevel_When_Point_Inside_Only_SecondaryToplevel ()
    {
        ...
        List<View?> found = Application.Running.GetViewsUnderLocation (new (7, 7), ViewportSettingsFlags.TransparentMouse);
    ...
    public void Returns_Depends_On_Margin_ViewportSettings_When_Point_In_Margin_Of_SecondaryToplevel ()
    {
        ...
        List<View?> found = Application.Running.GetViewsUnderLocation (new (5, 5), ViewportSettingsFlags.TransparentMouse);
        ...
        found = Application.Running.GetViewsUnderLocation (new (5, 5), ViewportSettingsFlags.TransparentMouse);
    ...
    public void Returns_Empty_When_Point_Outside_All_Toplevels ()
    {
        ...
        List<View?> found = Application.Running.GetViewsUnderLocation (new (20, 20), ViewportSettingsFlags.TransparentMouse);
        Assert.Empty (found);
