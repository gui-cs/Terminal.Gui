...
public class ApplicationMouseEnterLeaveTests
{
    ...
    {
        // Arrange
        Application.Running = new () { Frame = new (0, 0, 10, 10) };
    ...
    public void RaiseMouseEnterLeaveEvents_MouseMovesBetweenAdjacentViews_CallsOnMouseEnterAndLeave ()
    {
        ...
        Application.Running.Add (view1);
        Application.Running.Add (view2);
        ...
        try
        {
            ...
            Application.RaiseMouseEnterLeaveEvents (
                                                    mousePosition,
                                                    Application.Running.GetViewsUnderLocation (mousePosition, ViewportSettingsFlags.TransparentMouse));
