...
public class TreeViewTests (ITestOutputHelper output)
{
    ...
    public void ObjectActivationButton_DoubleClick ()
    {
        ...
        tree.NewMouseEvent (new Mouse { Flags = MouseFlags.Button1DoubleClicked });
    ...
    public void ObjectActivationButton_RightClick ()
    {
        ...
        tree.NewMouseEvent (new Mouse { Position = new (0, 1), Flags = MouseFlags.Button1DoubleClicked });

        Assert.Null (activated);
        Assert.False (called);

        tree.NewMouseEvent (new Mouse { Position = new (0, 1), Flags = MouseFlags.Button2Clicked });
