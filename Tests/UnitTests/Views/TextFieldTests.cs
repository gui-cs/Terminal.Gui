...
public class TextFieldTests (ITestOutputHelper output)
{
    ...
    public void Copy_Paste_Text_Changing_Updates_Cursor_Position ()
    {
        ...
        Assert.Equal (string.Empty, _textField.Text);
        Assert.Equal (0, _textField.CursorPos);
        _textField.Paste ();
        Assert.Equal ("TAB to jump", _textField.Text);
        Assert.Equal (11, _textField.CursorPos);
    ...
    public void KeyBindings_Command ()
    {
        ...
        Assert.Equal ("is is a test.", tf.Text);
        Assert.Equal (tf.Text.Length, tf.CursorPos);
        tf.CursorPos = 5;
        tf.SelectedStart = -1;
        Assert.Null (tf.SelectedText);
        ...
        Assert.Equal ("is is a t", tf.Text);
        Assert.Equal (8, tf.CursorPos);
        Assert.True (tf.NewKeyDownEvent (Key.CursorUp.WithCtrl));
        Assert.Equal ("is is a t", tf.Text);
        Assert.Equal (6, tf.CursorPos);
#if UNIX_KEY_BINDINGS
    ...
    public void Selected_Text_Shows ()
    {
        ...
        Assert.Equal (4, _textField.CursorPos);
    ...
    {
        _textField.CursorPos = _textField.Text.Length;
        var iteration = 0;

        while (_textField.CursorPos > 0)
        {
            ...
            {
                case 0:
                    Assert.Equal (31, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 1:
                    Assert.Equal (25, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 2:
                    Assert.Equal (20, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 3:
                    Assert.Equal (12, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 4:
                    Assert.Equal (7, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
    ...
    public void WordBackward_With_No_Selection_And_With_More_Than_Only_One_Whitespace_And_With_Only_One_Letter ()
    {
        ...
        while (_textField.CursorPos > 0)
        {
            ...
            {
                case 0:
                    Assert.Equal (54, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 1:
                    Assert.Equal (48, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 2:
                    Assert.Equal (46, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 3:
                    Assert.Equal (40, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 4:
                    Assert.Equal (38, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 5:
                    Assert.Equal (28, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                ...
                case 7:
                    ...
                    break;
                case 8:
                    Assert.Equal (9, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
                    ...
                    break;
                case 9:
                    Assert.Equal (6, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
    ...
    public void WordForward_With_No_Selection ()
    {
        ...
        while (_textField.CursorPos < _textField.Text.Length)
        {
        ...
        while (_textField.CursorPos < _textField.Text.Length)
        {
            ...
            switch (iteration)
            {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    Assert.Equal (55, _textField.CursorPos);
                    Assert.Equal (-1, _textField.SelectedStart);
                    Assert.Equal (0, _textField.SelectedLength);
                    Assert.Null (_textField.SelectedText);
