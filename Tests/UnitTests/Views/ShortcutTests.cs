...
public class ShortcutTests
{
    ...
    public void MouseClick_Raises_Accepted (int x, int expectedAccepted)
    {
        ...
        Application.Running.Add (shortcut);
    ...
    )
    {
        ...
        Application.Running.Add (shortcut);
        Application.Running.SetRelativeLayout (new (100, 100));
        Application.Running.LayoutSubViews ();
    ...
    {
        Application.Running = new () { App = Application.Create () };
    ...
    public void Scheme_SetScheme_Does_Not_Fault_3664 ()
    {
        ...
        Application.Running.SetScheme (null);
