...
│└+Route 66    │Great race course      │";
        ...
        Assert.True (tv.NewMouseEvent (new Mouse { Position = new (2, 2), Flags = MouseFlags.Button1Clicked }));
...
";
        ...
        tv.NewMouseEvent (new Mouse { Position = new (3, 2), Flags = MouseFlags.Button1Clicked });
        tv.Draw ();
        DriverAssert.AssertDriverContentsAre (expected, _output);
        tv.NewMouseEvent (new Mouse { Position = new (1, 2), Flags = MouseFlags.Button1Clicked });
        tv.Draw ();
        DriverAssert.AssertDriverContentsAre (expected, _output);

        // Clicking on the + again should collapse
        tv.NewMouseEvent (new Mouse { Position = new (2, 2), Flags = MouseFlags.Button1Clicked });
        tv.SetClipToScreen ();
        tv.Draw ();
