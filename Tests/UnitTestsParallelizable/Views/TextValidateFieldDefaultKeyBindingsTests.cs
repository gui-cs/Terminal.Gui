...
public class TextValidateFieldDefaultKeyBindingsTests
{
    ...
    {
        foreach ((string commandName, PlatformKeyBinding platformBinding) in TextValidateField.DefaultKeyBindings!)
        {
    ...
    {
        foreach (string commandName in TextValidateField.DefaultKeyBindings!.Keys)
        {
