...
public class PopoverMenuDefaultKeyBindingsTests
{
    ...
    {
        foreach ((string commandName, PlatformKeyBinding platformBinding) in PopoverMenu.DefaultKeyBindings!)
        {
    ...
    {
        foreach (string commandName in PopoverMenu.DefaultKeyBindings!.Keys)
        {
