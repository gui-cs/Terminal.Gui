...
public class DropDownListDefaultKeyBindingsTests
{
    ...
    {
        foreach ((string commandName, PlatformKeyBinding platformBinding) in DropDownList.DefaultKeyBindings!)
        {
    ...
    {
        foreach (string commandName in DropDownList.DefaultKeyBindings!.Keys)
        {
    ...
    [Fact]
    public void DropDownList_DefaultKeyBindings_ContainsToggle () => Assert.True (DropDownList.DefaultKeyBindings!.ContainsKey ("Toggle"));
}
