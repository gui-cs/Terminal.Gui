...
[![Version](https://img.shields.io/nuget/v/Terminal.UI.svg)](https://www.nuget.org/packages/Terminal.Gui)
...
# Terminal.UI - Cross Platform Terminal UI toolkit for .NET
...
Paste these commands into your favorite terminal on Windows, Mac, or Linux. This will install the [Terminal.UI.Templates](https://github.com/gui-cs/Terminal.UI.templates), create a new "Hello World" TUI app, and run it.

(Press `CTRL-Q` to exit the app)

```powershell
dotnet new --install Terminal.UI.templates
...
* [API Documentation](https://gui-cs.github.io/Terminal.Gui/api/Terminal.Gui/Terminal.UI.html)

_The Documentation matches the most recent Nuget release from the `main` branch ([![Version](https://img.shields.io/nuget/v/Terminal.UI.svg)](https://www.nuget.org/packages/Terminal.Gui))_
...
* **Clipboard support** - Cut, Copy, and Paste of text provided through the [`Clipboard`](https://gui-cs.github.io/Terminal.Gui/api/Terminal.Gui/Terminal.UI.Clipboard.html) class.
* **[Arbitrary Views](https://gui-cs.github.io/Terminal.Gui/api/Terminal.Gui/Terminal.UI.View.html)** - All visible UI elements are subclasses of the `View` class, and these in turn can contain an arbitrary number of sub-views.
* **Advanced App Features** - The [Mainloop](https://gui-cs.github.io/Terminal.Gui/api/Terminal.Gui/Terminal.UI.MainLoop.html) supports processing events, idle handlers, timers, and monitoring file
...
* **[F# Example](https://github.com/gui-cs/Terminal.Gui/tree/master/FSharpExample)** - An example showing how to build a Terminal.UI app using F#.
...
* **[TerminalGuiDesigner](https://github.com/tznind/TerminalGuiDesigner)** - Cross platform view designer for building Terminal.UI applications.
...
The following example shows a basic Terminal.UI application written in C#:
...
Use NuGet to install the `Terminal.UI` NuGet package: https://www.nuget.org/packages/Terminal.Gui

### Installation in .NET Core Projects

To install Terminal.UI into a .NET Core project, use the `dotnet` CLI tool with following command.

```
dotnet add package Terminal.UI
```

Or, you can use the [Terminal.UI.Templates](https://github.com/gui-cs/Terminal.UI.templates).
