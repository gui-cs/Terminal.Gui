...
public class MinimalSpinnerDemo : Scenario
{
    public override void Main ()
    {
        ...
        CheckBox chkSyncWithTerminal = new ()
        {
            Text = "SyncWithTerminal",
            X = Pos.Center (),
        ...
        Label lblSequence = new ()
        {
            ...
            X = Pos.Center (),
            Y = Pos.Bottom (chkSyncWithTerminal) + 1
        };
        ...
        main.Add (spinner, chkAutoSpin, chkSyncWithTerminal, lblSequence, tfSequence, btnAdvance);
