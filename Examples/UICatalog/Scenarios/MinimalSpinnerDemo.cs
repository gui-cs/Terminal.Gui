...
public class MinimalSpinnerDemo : Scenario
{
    public override void Main ()
    {
        ...
        CheckBox chkUseProgressIndicator = new ()
        {
            Text = "UseProgressIndicator",
            X = Pos.Center (),
        ...
        Label lblSequence = new ()
        {
            ...
            X = Pos.Center (),
            Y = Pos.Bottom (chkUseProgressIndicator) + 1
        };
        ...
        main.Add (spinner, chkAutoSpin, chkUseProgressIndicator, lblSequence, tfSequence, btnAdvance);
