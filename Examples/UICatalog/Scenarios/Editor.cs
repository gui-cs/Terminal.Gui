...
public class Editor : Scenario
{
    ...
    private void CloseFile ()
    {
        ...
        {
            MessageBox.ErrorQuery (_appWindow!.App!, "Error", ex.Message, "_Ok");
        }
    }
    ...
    private void ContinueFind (bool next = true, bool replace = false)
    {
        ...
        if (!found)
        {
            MessageBox.Query (_appWindow!.App!, "Find", $"The following specified text was not found: '{_textToFind}'", "_Ok");
        }
    ...
    private bool SaveFile (string title, string file)
    {
        ...
        try
        {
            ...
            MessageBox.Query (_appWindow.App!, "Save File", "File was successfully saved.", "_Ok");
        }
        catch (Exception ex)
        {
            MessageBox.ErrorQuery (_appWindow.App!, "Error", ex.Message, "_Ok");
